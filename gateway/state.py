...
TOOL_ADDENDUM = (
    ...
    f"home directory ({Path.home()}). Shared uploads are in {Path.home() / 'nvidia-workbench' / 'terminal-llm' / 'shared'}. "
    ...
    f"and saved on this server in {Path.home() / 'nvidia-workbench' / 'terminal-llm' / 'shared'}. "
