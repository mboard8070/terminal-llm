...
def _dispatch_calendar_update_event(args):
    ...
    return calendar_update_event(
        args.get("event_id", ""), args.get("summary"), args.get("start"), args.get("end"),
        args.get("description"), args.get("location"), args.get("calendar_id", "primary"))
...
def _dispatch_slides_add_text(args):
    ...
    return slides_add_text(
        args.get("presentation_id", ""), args.get("slide_id", ""), args.get("text", ""),
        args.get("x", 100), args.get("y", 100), args.get("width", 400), args.get("height", 300))
...
def _dispatch_contacts_create(args):
    ...
    return contacts_create(
        args.get("given_name", ""), args.get("family_name", ""),
        args.get("email"), args.get("phone"), args.get("organization"))
...
def _dispatch_contacts_update(args):
    ...
    return contacts_update(
        args.get("resource_name", ""), args.get("given_name"),
        args.get("family_name"), args.get("email"), args.get("phone"))
