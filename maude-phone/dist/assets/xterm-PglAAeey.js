function me(se, le) {
  for (var te = 0; te < le.length; te++) {
    ...
    if (typeof Y != "string" && !Array.isArray(Y)) {
      for (const G in Y) if (G !== "default" && !(G in se)) {
        const ie = Object.getOwnPropertyDescriptor(Y, G);
        ie && Object.defineProperty(se, G, ie.get ? ie : { enumerable: true, get: () => Y[G] });
      }
    }
  }
...
(function(se, le) {
  (function(te, Y) {
    ...
    var te = { 4567: function(O, r, o) {
      var l = this && this.__decorate || function(e, t, a, u) {
        var _, p = arguments.length, c = p < 3 ? t : u === null ? u = Object.getOwnPropertyDescriptor(t, a) : u;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") c = Reflect.decorate(e, t, a, u);
        else for (var m = e.length - 1; m >= 0; m--) (_ = e[m]) && (c = (p < 3 ? _(c) : p > 3 ? _(t, a, c) : _(t, a)) || c);
      ...
      const n = o(9042), d = o(9924), v = o(844), g = o(4725), h = o(2585), i = o(3656);
      let s = r.AccessibilityManager = class extends v.Disposable {
        constructor(e, t, a, u) {
          super(), this._terminal = e, this._coreBrowserService = a, this._renderService = u, this._rowColumns = /* @__PURE__ */ new WeakMap(), this._liveRegionLineCount = 0, this._charsToConsume = [], this._charsToAnnounce = "", this._accessibilityContainer = this._coreBrowserService.mainDocument.createElement("div"), this._accessibilityContainer.classList.add("xterm-accessibility"), this._rowContainer = this._coreBrowserService.mainDocument.createElement("div"), this._rowContainer.setAttribute("role", "list"), this._rowContainer.classList.add("xterm-accessibility-tree"), this._rowElements = [];
...
` && (this._liveRegionLineCount++, this._liveRegionLineCount === 21 && (this._liveRegion.textContent += n.tooMuchOutput)));
        ...
        _renderRows(e, t) {
          const a = this._terminal.buffer, u = a.lines.length.toString();
          for (let _ = e; _ <= t; _++) {
            const p = a.lines.get(a.ydisp + _), c = [], m = (p == null ? void 0 : p.translateToString(true, void 0, void 0, c)) || "", E = (a.ydisp + _ + 1).toString(), k = this._rowElements[_];
            k && (m.length === 0 ? (k.innerText = "\xA0", this._rowColumns.set(k, [0, 1])) : (k.textContent = m, this._rowColumns.set(k, c)), k.setAttribute("aria-posinset", E), k.setAttribute("aria-setsize", u));
          }
        ...
        _handleBoundaryFocus(e, t) {
          const a = e.target, u = this._rowElements[t === 0 ? 1 : this._rowElements.length - 2];
          if (a.getAttribute("aria-posinset") === (t === 0 ? "1" : `${this._terminal.buffer.lines.length}`) || e.relatedTarget !== u) return;
          let _, p;
          if (t === 0 ? (_ = a, p = this._rowElements.pop(), this._rowContainer.removeChild(p)) : (_ = this._rowElements.shift(), p = a, this._rowContainer.removeChild(_)), _.removeEventListener("focus", this._topBoundaryFocusListener), p.removeEventListener("focus", this._bottomBoundaryFocusListener), t === 0) {
        ...
        _handleSelectionChange() {
          ...
          if (a.node.compareDocumentPosition(u) & (Node.DOCUMENT_POSITION_CONTAINED_BY | Node.DOCUMENT_POSITION_PRECEDING) && (a = { node: u, offset: ((_a = u.textContent) == null ? void 0 : _a.length) ?? 0 }), !this._rowContainer.contains(a.node)) return;
          const _ = ({ node: m, offset: E }) => {
            const k = m instanceof Text ? m.parentNode : m;
            let D = parseInt(k == null ? void 0 : k.getAttribute("aria-posinset"), 10) - 1;
            ...
            return x >= this._terminal.cols && (++D, x = 0), { row: D, column: x };
          }, p = _(t), c = _(a);
          if (p && c) {
      ...
      function f(d, v, g, h) {
        d = l(d = o(d), g.decPrivateModes.bracketedPasteMode && h.rawOptions.ignoreBracketedPasteMode !== true), g.triggerDataEvent(d, true), v.value = "";
      }
      function n(d, v, g) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.rightClickHandler = r.moveTextAreaUnderMouseCursor = r.paste = r.handlePasteEvent = r.copyHandler = r.bracketTextForPaste = r.prepareTextForTerminal = void 0, r.prepareTextForTerminal = o, r.bracketTextForPaste = l, r.copyHandler = function(d, v) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.addDisposableDomListener = void 0, r.addDisposableDomListener = function(o, l, f, n) {
        o.addEventListener(l, f, n);
        let d = false;
        return { dispose: () => {
          d || (d = true, o.removeEventListener(l, f, n));
        } };
      };
    }, 3551: function(O, r, o) {
      var l = this && this.__decorate || function(s, e, t, a) {
        var u, _ = arguments.length, p = _ < 3 ? e : a === null ? a = Object.getOwnPropertyDescriptor(e, t) : a;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") p = Reflect.decorate(s, e, t, a);
      ...
      let i = r.Linkifier = class extends v.Disposable {
        ...
        _askForLink(s, e) {
          var _a, _b;
          this._activeProviderReplies && e || ((_a = this._activeProviderReplies) == null ? void 0 : _a.forEach((a) => {
            a == null ? void 0 : a.forEach((u) => {
              u.link.dispose && u.link.dispose();
            });
          }), this._activeProviderReplies = /* @__PURE__ */ new Map(), this._activeLine = s.y);
          let t = false;
          for (const [a, u] of this._linkProviderService.linkProviders.entries()) e ? ((_b = this._activeProviderReplies) == null ? void 0 : _b.get(a)) && (t = this._checkLinkProviderResult(a, s, t)) : u.provideLinks(s.y, (_) => {
            var _a2, _b2;
            if (this._isMouseOut) return;
            const p = _ == null ? void 0 : _.map((c) => ({ link: c }));
            (_a2 = this._activeProviderReplies) == null ? void 0 : _a2.set(a, p), t = this._checkLinkProviderResult(a, s, t), ((_b2 = this._activeProviderReplies) == null ? void 0 : _b2.size) === this._linkProviderService.linkProviders.length && this._removeIntersectingLinks(s.y, this._activeProviderReplies);
          });
        }
        ...
        _checkLinkProviderResult(s, e, t) {
          ...
          let u = false;
          for (let _ = 0; _ < s; _++) this._activeProviderReplies.has(_) && !this._activeProviderReplies.get(_) || (u = true);
          if (!u && a) {
            const _ = a.find((p) => this._linkAtPosition(p.link, e));
            _ && (t = true, this._handleNewLink(_));
          }
          if (this._activeProviderReplies.size === this._linkProviderService.linkProviders.length && !t) for (let _ = 0; _ < this._activeProviderReplies.size; _++) {
            const p = (_a = this._activeProviderReplies.get(_)) == null ? void 0 : _a.find((c) => this._linkAtPosition(c.link, e));
            if (p) {
              t = true, this._handleNewLink(p);
              break;
            }
          }
          return t;
        ...
        _handleNewLink(s) {
          ...
          e && this._linkAtPosition(s.link, e) && (this._currentLink = s, this._currentLink.state = { decorations: { underline: s.link.decorations === void 0 || s.link.decorations.underline, pointerCursor: s.link.decorations === void 0 || s.link.decorations.pointerCursor }, isHovered: true }, this._linkHover(this._element, s.link, this._lastMouseEvent), s.link.decorations = {}, Object.defineProperties(s.link.decorations, { pointerCursor: { get: () => {
            ...
            var _a;
            ((_a = this._currentLink) == null ? void 0 : _a.state) && this._currentLink.state.decorations.pointerCursor !== t && (this._currentLink.state.decorations.pointerCursor = t, this._currentLink.state.isHovered && this._element.classList.toggle("xterm-cursor-pointer", t));
          } }, underline: { get: () => {
            var _a, _b;
            return (_b = (_a = this._currentLink) == null ? void 0 : _a.state) == null ? void 0 : _b.decorations.underline;
          }, set: (t) => {
            var _a, _b, _c;
            ((_a = this._currentLink) == null ? void 0 : _a.state) && ((_c = (_b = this._currentLink) == null ? void 0 : _b.state) == null ? void 0 : _c.decorations.underline) !== t && (this._currentLink.state.decorations.underline = t, this._currentLink.state.isHovered && this._fireUnderlineEvent(s.link, t));
          } } }), this._linkCacheDisposables.push(this._renderService.onRenderedViewportChange((t) => {
            if (!this._currentLink) return;
            const a = t.start === 0 ? 0 : t.start + 1 + this._bufferService.buffer.ydisp, u = this._bufferService.buffer.ydisp + 1 + t.end;
            if (this._currentLink.link.range.start.y >= a && this._currentLink.link.range.end.y <= u && (this._clearCurrentLink(a, u), this._lastMouseEvent)) {
        ...
        _linkHover(s, e, t) {
          var _a;
          ((_a = this._currentLink) == null ? void 0 : _a.state) && (this._currentLink.state.isHovered = true, this._currentLink.state.decorations.underline && this._fireUnderlineEvent(e, true), this._currentLink.state.decorations.pointerCursor && s.classList.add("xterm-cursor-pointer")), e.hover && e.hover(t, e.text);
        }
        _fireUnderlineEvent(s, e) {
          const t = s.range, a = this._bufferService.buffer.ydisp, u = this._createLinkUnderlineEvent(t.start.x - 1, t.start.y - a - 1, t.end.x, t.end.y - a - 1, void 0);
          (e ? this._onShowLinkUnderline : this._onHideLinkUnderline).fire(u);
        }
        _linkLeave(s, e, t) {
          var _a;
          ((_a = this._currentLink) == null ? void 0 : _a.state) && (this._currentLink.state.isHovered = false, this._currentLink.state.decorations.underline && this._fireUnderlineEvent(e, false), this._currentLink.state.decorations.pointerCursor && s.classList.remove("xterm-cursor-pointer")), e.leave && e.leave(t, e.text);
        }
        _linkAtPosition(s, e) {
          const t = s.range.start.y * this._bufferService.cols + s.range.start.x, a = s.range.end.y * this._bufferService.cols + s.range.end.x, u = e.y * this._bufferService.cols + e.x;
          return t <= u && u <= a;
        }
        ...
        _createLinkUnderlineEvent(s, e, t, a, u) {
          return { x1: s, y1: e, x2: t, y2: a, cols: this._bufferService.cols, fg: u };
        }
      };
      ...
      var l = this && this.__decorate || function(h, i, s, e) {
        var t, a = arguments.length, u = a < 3 ? i : e === null ? e = Object.getOwnPropertyDescriptor(i, s) : e;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") u = Reflect.decorate(h, i, s, e);
        else for (var _ = h.length - 1; _ >= 0; _--) (t = h[_]) && (u = (a < 3 ? t(u) : a > 3 ? t(i, s, u) : t(i, s)) || u);
        return a > 3 && u && Object.defineProperty(i, s, u), u;
      ...
      let v = r.OscLinkProvider = class {
        ...
        provideLinks(h, i) {
          ...
          const e = [], t = this._optionsService.rawOptions.linkHandler, a = new n.CellData(), u = s.getTrimmedLength();
          let _ = -1, p = -1, c = false;
          for (let m = 0; m < u; m++) if (p !== -1 || s.hasContent(m)) {
            if (s.loadCell(m, a), a.hasExtendedAttrs() && a.extended.urlId) {
              if (p === -1) {
                p = m, _ = a.extended.urlId;
                continue;
              }
              c = a.extended.urlId !== _;
            } else p !== -1 && (c = true);
            if (c || p !== -1 && m === u - 1) {
              const E = (_a = this._oscLinkService.getLinkData(_)) == null ? void 0 : _a.uri;
              if (E) {
                const k = { start: { x: p + 1, y: h }, end: { x: m + (c || m !== u - 1 ? 0 : 1), y: h } };
                let D = false;
                if (!(t == null ? void 0 : t.allowNonHttpProtocols)) try {
                  const b = new URL(E);
                  ["http:", "https:"].includes(b.protocol) || (D = true);
                } catch {
                  D = true;
                }
                D || e.push({ text: E, range: k, activate: (b, x) => t ? t.activate(b, x, k) : g(0, x), hover: (b, x) => {
                  var _a2;
                  return (_a2 = t == null ? void 0 : t.hover) == null ? void 0 : _a2.call(t, b, x, k);
                }, leave: (b, x) => {
                  var _a2;
                  return (_a2 = t == null ? void 0 : t.leave) == null ? void 0 : _a2.call(t, b, x, k);
                } });
              }
              c = false, a.hasExtendedAttrs() && a.extended.urlId ? (p = m, _ = a.extended.urlId) : (p = -1, _ = -1);
            }
          }
          i(e);
        }
...
WARNING: This link could potentially be dangerous`)) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.RenderDebouncer = void 0, r.RenderDebouncer = class {
        ...
        refresh(o, l, f) {
          this._rowCount = f, o = o !== void 0 ? o : 0, l = l !== void 0 ? l : this._rowCount - 1, this._rowStart = this._rowStart !== void 0 ? Math.min(this._rowStart, o) : o, this._rowEnd = this._rowEnd !== void 0 ? Math.max(this._rowEnd, l) : l, this._animationFrame || (this._animationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._innerRefresh()));
        }
        _innerRefresh() {
      ...
      const l = o(3614), f = o(3656), n = o(3551), d = o(9042), v = o(3730), g = o(1680), h = o(3107), i = o(5744), s = o(2950), e = o(1296), t = o(428), a = o(4269), u = o(5114), _ = o(8934), p = o(3230), c = o(9312), m = o(4725), E = o(6731), k = o(8055), D = o(8969), b = o(8460), x = o(844), T = o(6114), I = o(8437), U = o(2584), P = o(7399), S = o(5941), w = o(9074), y = o(2585), L = o(5435), B = o(4567), H = o(779);
      class N extends D.CoreTerminal {
        ...
        _handleColorEvent(R) {
          if (this._themeService) for (const C of R) {
            ...
            switch (C.type) {
              case 0:
                const W = k.color.toColorRGB(A === "ansi" ? this._themeService.colors.ansi[C.index] : this._themeService.colors[A]);
                this.coreService.triggerDataEvent(`${U.C0.ESC}]${M};${(0, S.toRgbString)(W)}${U.C1_ESCAPED.ST}`);
                break;
              case 1:
                if (A === "ansi") this._themeService.modifyColors((F) => F.ansi[C.index] = k.channels.toColor(...C.color));
                else {
                  const F = A;
        ...
        _handleScreenReaderModeOptionChange(R) {
          R ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(B.AccessibilityManager, this)) : this._accessibilityManager.clear();
        }
        ...
        _syncTextArea() {
          ...
          if (!C) return;
          const A = Math.min(this.buffer.x, this.cols - 1), M = this._renderService.dimensions.css.cell.height, W = C.getWidth(A), F = this._renderService.dimensions.css.cell.width * W, z = this.buffer.y * this._renderService.dimensions.css.cell.height, q = A * this._renderService.dimensions.css.cell.width;
          this.textarea.style.left = q + "px", this.textarea.style.top = z + "px", this.textarea.style.width = F + "px", this.textarea.style.height = M + "px", this.textarea.style.lineHeight = M + "px", this.textarea.style.zIndex = "-5";
        }
        _initGlobal() {
          ...
          this.register((0, f.addDisposableDomListener)(this.textarea, "paste", R)), this.register((0, f.addDisposableDomListener)(this.element, "paste", R)), T.isFirefox ? this.register((0, f.addDisposableDomListener)(this.element, "mousedown", (C) => {
          ...
          })), T.isLinux && this.register((0, f.addDisposableDomListener)(this.element, "auxclick", (C) => {
        ...
        open(R) {
          ...
          if (R.isConnected || this._logService.debug("Terminal.open was called on an element that was not attached to the DOM"), ((_a = this.element) == null ? void 0 : _a.ownerDocument.defaultView) && this._coreBrowserService) return void (this.element.ownerDocument.defaultView !== this._coreBrowserService.window && (this._coreBrowserService.window = this.element.ownerDocument.defaultView));
        ...
        bindMouse() {
          ...
          const M = { mouseup: null, wheel: null, mousedrag: null, mousemove: null }, W = { mouseup: (F) => (A(F), F.buttons || (this._document.removeEventListener("mouseup", M.mouseup), M.mousedrag && this._document.removeEventListener("mousemove", M.mousedrag)), this.cancel(F)), wheel: (F) => (A(F), this.cancel(F, true)), mousedrag: (F) => {
            F.buttons && A(F);
          }, mousemove: (F) => {
            F.buttons || A(F);
          } };
          this.register(this.coreMouseService.onProtocolChange((F) => {
            F ? (this.optionsService.rawOptions.logLevel === "debug" && this._logService.debug("Binding to mouse events:", this.coreMouseService.explainEvents(F)), this.element.classList.add("enable-mouse-events"), this._selectionService.disable()) : (this._logService.debug("Unbinding from mouse events."), this.element.classList.remove("enable-mouse-events"), this._selectionService.enable()), 8 & F ? M.mousemove || (C.addEventListener("mousemove", W.mousemove), M.mousemove = W.mousemove) : (C.removeEventListener("mousemove", M.mousemove), M.mousemove = null), 16 & F ? M.wheel || (C.addEventListener("wheel", W.wheel, { passive: false }), M.wheel = W.wheel) : (C.removeEventListener("wheel", M.wheel), M.wheel = null), 2 & F ? M.mouseup || (M.mouseup = W.mouseup) : (this._document.removeEventListener("mouseup", M.mouseup), M.mouseup = null), 4 & F ? M.mousedrag || (M.mousedrag = W.mousedrag) : (this._document.removeEventListener("mousemove", M.mousedrag), M.mousedrag = null);
            ...
            if (F.preventDefault(), this.focus(), this.coreMouseService.areMouseEventsActive && !this._selectionService.shouldForceSelection(F)) return A(F), M.mouseup && this._document.addEventListener("mouseup", M.mouseup), M.mousedrag && this._document.addEventListener("mousemove", M.mousedrag), this.cancel(F);
        ...
        refresh(R, C) {
          var _a;
          (_a = this._renderService) == null ? void 0 : _a.refreshRows(R, C);
        }
        updateCursorStyle(R) {
          var _a;
          ((_a = this._selectionService) == null ? void 0 : _a.shouldColumnSelect(R)) ? this.element.classList.add("column-select") : this.element.classList.remove("column-select");
        }
        _showCursor() {
        ...
        scrollLines(R, C, A = 0) {
          var _a;
          A === 1 ? (super.scrollLines(R, C, A), this.refresh(0, this.rows - 1)) : (_a = this.viewport) == null ? void 0 : _a.scrollLines(R);
        }
        paste(R) {
        ...
        selectLines(R, C) {
          var _a;
          (_a = this._selectionService) == null ? void 0 : _a.selectLines(R, C);
        }
        _keyDown(R) {
          ...
          const A = (0, P.evaluateKeyboardEvent)(R, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
          if (this.updateCursorStyle(R), A.type === 3 || A.type === 2) {
            const M = this.rows - 1;
            return this.scrollLines(A.type === 2 ? -M : M), this.cancel(R, true);
          }
          return A.type === 1 && this.selectAll(), !!this._isThirdLevelShift(this.browser, R) || (A.cancel && this.cancel(R, true), !A.key || !!(R.key && !R.ctrlKey && !R.altKey && !R.metaKey && R.key.length === 1 && R.key.charCodeAt(0) >= 65 && R.key.charCodeAt(0) <= 90) || (this._unprocessedDeadKey ? (this._unprocessedDeadKey = false, true) : (A.key !== U.C0.ETX && A.key !== U.C0.CR || (this.textarea.value = ""), this._onKey.fire({ key: A.key, domEvent: R }), this._showCursor(), this.coreService.triggerDataEvent(A.key, true), !this.optionsService.rawOptions.screenReaderMode || R.altKey || R.ctrlKey ? this.cancel(R, true) : void (this._keyDownHandled = true))));
        }
        _isThirdLevelShift(R, C) {
          const A = R.isMac && !this.options.macOptionIsMeta && C.altKey && !C.ctrlKey && !C.metaKey || R.isWindows && C.altKey && C.ctrlKey && !C.metaKey || R.isWindows && C.getModifierState("AltGraph");
        ...
        reset() {
          ...
          this._setup(), super.reset(), (_a = this._selectionService) == null ? void 0 : _a.reset(), this._decorationService.reset(), (_b = this.viewport) == null ? void 0 : _b.reset(), this._customKeyEventHandler = R, this.refresh(0, this.rows - 1);
        }
        clearTextureAtlas() {
          var _a;
        ...
        _reportFocus() {
          var _a;
          ((_a = this.element) == null ? void 0 : _a.classList.contains("focus")) ? this.coreService.triggerDataEvent(U.C0.ESC + "[I") : this.coreService.triggerDataEvent(U.C0.ESC + "[O");
        }
        _reportWindowsOptions(R) {
          if (this._renderService) switch (R) {
            case L.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
              const C = this._renderService.dimensions.css.canvas.width.toFixed(0), A = this._renderService.dimensions.css.canvas.height.toFixed(0);
              this.coreService.triggerDataEvent(`${U.C0.ESC}[4;${A};${C}t`);
              break;
            case L.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
              const M = this._renderService.dimensions.css.cell.width.toFixed(0), W = this._renderService.dimensions.css.cell.height.toFixed(0);
              this.coreService.triggerDataEvent(`${U.C0.ESC}[6;${W};${M}t`);
          }
        }
        cancel(R, C) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.TimeBasedDebouncer = void 0, r.TimeBasedDebouncer = class {
        constructor(o, l = 1e3) {
          this._renderCallback = o, this._debounceThresholdMS = l, this._lastRefreshMs = 0, this._additionalRefreshRequested = false;
        }
        dispose() {
          this._refreshTimeoutID && clearTimeout(this._refreshTimeoutID);
        }
        refresh(o, l, f) {
          this._rowCount = f, o = o !== void 0 ? o : 0, l = l !== void 0 ? l : this._rowCount - 1, this._rowStart = this._rowStart !== void 0 ? Math.min(this._rowStart, o) : o, this._rowEnd = this._rowEnd !== void 0 ? Math.max(this._rowEnd, l) : l;
          const n = Date.now();
      ...
      let i = r.Viewport = class extends g.Disposable {
        ...
        getBufferElements(s, e) {
          var _a;
          let t, a = "";
          const u = [], _ = e ?? this._bufferService.buffer.lines.length, p = this._bufferService.buffer.lines;
          for (let c = s; c < _; c++) {
            const m = p.get(c);
            if (!m) continue;
            const E = (_a = p.get(c + 1)) == null ? void 0 : _a.isWrapped;
            if (a += m.translateToString(!E), !E || c === p.length - 1) {
              const k = document.createElement("div");
              k.textContent = a, u.push(k), a.length > 0 && (t = k), a = "";
            }
          }
      ...
      const n = o(4725), d = o(844), v = o(2585);
      let g = r.BufferDecorationRenderer = class extends d.Disposable {
        ...
        _createElement(h) {
          ...
          i.classList.add("xterm-decoration"), i.classList.toggle("xterm-decoration-top-layer", ((_a = h == null ? void 0 : h.options) == null ? void 0 : _a.layer) === "top"), i.style.width = `${Math.round((h.options.width || 1) * this._renderService.dimensions.css.cell.width)}px`, i.style.height = (h.options.height || 1) * this._renderService.dimensions.css.cell.height + "px", i.style.top = (h.marker.line - this._bufferService.buffers.active.ydisp) * this._renderService.dimensions.css.cell.height + "px", i.style.lineHeight = `${this._renderService.dimensions.css.cell.height}px`;
        ...
        _removeDecoration(h) {
          var _a;
          (_a = this._decorationElements.get(h)) == null ? void 0 : _a.remove(), this._decorationElements.delete(h), h.dispose();
        }
      };
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.ColorZoneStore = void 0, r.ColorZoneStore = class {
        ...
        _lineAdjacentToZone(o, l, f) {
          return l >= o.startBufferLine - this._linePadding[f || "full"] && l <= o.endBufferLine + this._linePadding[f || "full"];
        }
        _addLineToZone(o, l) {
      ...
      var l = this && this.__decorate || function(t, a, u, _) {
        var p, c = arguments.length, m = c < 3 ? a : _ === null ? _ = Object.getOwnPropertyDescriptor(a, u) : _;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") m = Reflect.decorate(t, a, u, _);
        else for (var E = t.length - 1; E >= 0; E--) (p = t[E]) && (m = (c < 3 ? p(m) : c > 3 ? p(a, u, m) : p(a, u)) || m);
        return c > 3 && m && Object.defineProperty(a, u, m), m;
      }, f = this && this.__param || function(t, a) {
        return function(u, _) {
          a(u, _, t);
        };
      };
      Object.defineProperty(r, "__esModule", { value: true }), r.OverviewRulerRenderer = void 0;
      const n = o(5871), d = o(4725), v = o(844), g = o(2585), h = { full: 0, left: 0, center: 0, right: 0 }, i = { full: 0, left: 0, center: 0, right: 0 }, s = { full: 0, left: 0, center: 0, right: 0 };
      let e = r.OverviewRulerRenderer = class extends v.Disposable {
        get _width() {
          return this._optionsService.options.overviewRulerWidth || 0;
        }
        constructor(t, a, u, _, p, c, m) {
          var _a;
          super(), this._viewportElement = t, this._screenElement = a, this._bufferService = u, this._decorationService = _, this._renderService = p, this._optionsService = c, this._coreBrowserService = m, this._colorZoneStore = new n.ColorZoneStore(), this._shouldUpdateDimensions = true, this._shouldUpdateAnchor = true, this._lastKnownBufferLength = 0, this._canvas = this._coreBrowserService.mainDocument.createElement("canvas"), this._canvas.classList.add("xterm-decoration-overview-ruler"), this._refreshCanvasDimensions(), (_a = this._viewportElement.parentElement) == null ? void 0 : _a.insertBefore(this._canvas, this._viewportElement);
          const E = this._canvas.getContext("2d");
          if (!E) throw new Error("Ctx cannot be null");
          this._ctx = E, this._registerDecorationListeners(), this._registerBufferChangeListeners(), this._registerDimensionChangeListeners(), this.register((0, v.toDisposable)(() => {
            var _a2;
      ...
      const n = o(4725), d = o(2585), v = o(2584);
      let g = r.CompositionHelper = class {
        get isComposing() {
          return this._isComposing;
        }
        constructor(h, i, s, e, t, a) {
          this._textarea = h, this._compositionView = i, this._bufferService = s, this._optionsService = e, this._coreService = t, this._renderService = a, this._isComposing = false, this._isSendingComposition = false, this._compositionPosition = { start: 0, end: 0 }, this._dataAlreadySent = "";
        }
        compositionstart() {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.getCoords = r.getCoordsRelativeToElement = void 0, r.getCoordsRelativeToElement = o, r.getCoords = function(l, f, n, d, v, g, h, i, s) {
        if (!g) return;
        const e = o(l, f, n);
      ...
      const l = o(2584);
      function f(i, s, e, t) {
        const a = i - n(i, e), u = s - n(s, e), _ = Math.abs(a - u) - function(p, c, m) {
          var _a;
          let E = 0;
          const k = p - n(p, m), D = c - n(c, m);
          for (let b = 0; b < Math.abs(k - D); b++) {
            const x = d(p, c) === "A" ? -1 : 1;
            ((_a = m.buffer.lines.get(k + x * b)) == null ? void 0 : _a.isWrapped) && E++;
          }
          return E;
        }(i, s, e);
      ...
      function v(i, s, e, t, a, u) {
        let _ = i, p = s, c = "";
        for (; _ !== e || p !== t; ) _ += a ? 1 : -1, a && _ > u.cols - 1 ? (c += u.buffer.translateBufferLineToString(p, false, i, _), _ = 0, i = 0, p++) : !a && _ < 0 && (c += u.buffer.translateBufferLineToString(p, false, 0, i + 1), _ = u.cols - 1, i = _, p--);
      ...
      let k = 1, D = r.DomRenderer = class extends t.Disposable {
        ...
        _updateDimensions() {
          ...
          for (const T of this._rowElements) T.style.width = `${this.dimensions.css.canvas.width}px`, T.style.height = `${this.dimensions.css.cell.height}px`, T.style.lineHeight = `${this.dimensions.css.cell.height}px`, T.style.overflow = "hidden";
        ...
        _injectCss(b) {
          ...
          let x = `${this._terminalSelector} .${_} { color: ${b.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
          x += `${this._terminalSelector} .${_} .xterm-dim { color: ${s.color.multiplyOpacity(b.foreground, 0.5).css};}`, x += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
          const T = `blink_underline_${this._terminalClass}`, I = `blink_bar_${this._terminalClass}`, U = `blink_block_${this._terminalClass}`;
          x += `@keyframes ${T} { 50% {  border-bottom-style: hidden; }}`, x += `@keyframes ${I} { 50% {  box-shadow: none; }}`, x += `@keyframes ${U} { 0% {  background-color: ${b.cursor.css};  color: ${b.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${b.cursor.css}; }}`, x += `${this._terminalSelector} .${_}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${T} 1s step-end infinite;}${this._terminalSelector} .${_}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${I} 1s step-end infinite;}${this._terminalSelector} .${_}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${U} 1s step-end infinite;}${this._terminalSelector} .${_} .xterm-cursor.xterm-cursor-block { background-color: ${b.cursor.css}; color: ${b.cursorAccent.css};}${this._terminalSelector} .${_} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${b.cursor.css} !important; color: ${b.cursorAccent.css} !important;}${this._terminalSelector} .${_} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${b.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${_} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${b.cursor.css} inset;}${this._terminalSelector} .${_} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${b.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, x += `${this._terminalSelector} .${E} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${E} div { position: absolute; background-color: ${b.selectionBackgroundOpaque.css};}${this._terminalSelector} .${E} div { position: absolute; background-color: ${b.selectionInactiveBackgroundOpaque.css};}`;
          for (const [P, S] of b.ansi.entries()) x += `${this._terminalSelector} .${p}${P} { color: ${S.css}; }${this._terminalSelector} .${p}${P}.xterm-dim { color: ${s.color.multiplyOpacity(S, 0.5).css}; }${this._terminalSelector} .${c}${P} { background-color: ${S.css}; }`;
          x += `${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR} { color: ${s.color.opaque(b.background).css}; }${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${s.color.multiplyOpacity(s.color.opaque(b.background), 0.5).css}; }${this._terminalSelector} .${c}${v.INVERTED_DEFAULT_COLOR} { background-color: ${b.foreground.css}; }`, this._themeStyleElement.textContent = x;
        }
        _setDefaultSpacing() {
          const b = this.dimensions.css.cell.width - this._widthCache.get("W", false, false);
        ...
        _refreshRowElements(b, x) {
          for (let T = this._rowElements.length; T <= x; T++) {
        ...
        handleSelectionChanged(b, x, T) {
          if (this._selectionContainer.replaceChildren(), this._rowFactory.handleSelectionChanged(b, x, T), this.renderRows(0, this._bufferService.rows - 1), !b || !x) return;
          this._selectionRenderModel.update(this._terminal, b, x, T);
          const I = this._selectionRenderModel.viewportStartRow, U = this._selectionRenderModel.viewportEndRow, P = this._selectionRenderModel.viewportCappedStartRow, S = this._selectionRenderModel.viewportCappedEndRow;
          if (P >= this._bufferService.rows || S < 0) return;
          const w = this._document.createDocumentFragment();
          if (T) {
            const y = b[0] > x[0];
            w.appendChild(this._createSelectionElement(P, y ? x[0] : b[0], y ? b[0] : x[0], S - P + 1));
          } else {
            const y = I === P ? b[0] : 0, L = P === U ? x[0] : this._bufferService.cols;
            w.appendChild(this._createSelectionElement(P, y, L));
            const B = S - P - 1;
            if (w.appendChild(this._createSelectionElement(P + 1, 0, this._bufferService.cols, B)), P !== S) {
        ...
        _createSelectionElement(b, x, T, I = 1) {
          const U = this._document.createElement("div"), P = x * this.dimensions.css.cell.width;
          let S = this.dimensions.css.cell.width * (T - x);
          return P + S > this.dimensions.css.canvas.width && (S = this.dimensions.css.canvas.width - P), U.style.height = I * this.dimensions.css.cell.height + "px", U.style.top = b * this.dimensions.css.cell.height + "px", U.style.left = `${P}px`, U.style.width = `${S}px`, U;
        }
        handleCursorMove() {
        }
        ...
        renderRows(b, x) {
          const T = this._bufferService.buffer, I = T.ybase + T.y, U = Math.min(T.x, this._bufferService.cols - 1), P = this._optionsService.rawOptions.cursorBlink, S = this._optionsService.rawOptions.cursorStyle, w = this._optionsService.rawOptions.cursorInactiveStyle;
          for (let y = b; y <= x; y++) {
            const L = y + T.ydisp, B = this._rowElements[y], H = T.lines.get(L);
            if (!B || !H) break;
            B.replaceChildren(...this._rowFactory.createRow(H, L, L === I, S, w, U, P, this.dimensions.css.cell.width, this._widthCache, -1, -1));
          }
        }
        ...
        _handleLinkHover(b) {
          this._setCellUnderline(b.x1, b.x2, b.y1, b.y2, b.cols, true);
        }
        _handleLinkLeave(b) {
          this._setCellUnderline(b.x1, b.x2, b.y1, b.y2, b.cols, false);
        }
        _setCellUnderline(b, x, T, I, U, P) {
          T < 0 && (b = 0), I < 0 && (x = 0);
          const S = this._bufferService.rows - 1;
          T = Math.max(Math.min(T, S), 0), I = Math.max(Math.min(I, S), 0), U = Math.min(U, this._bufferService.cols);
          const w = this._bufferService.buffer, y = w.ybase + w.y, L = Math.min(w.x, U - 1), B = this._optionsService.rawOptions.cursorBlink, H = this._optionsService.rawOptions.cursorStyle, N = this._optionsService.rawOptions.cursorInactiveStyle;
          for (let $ = T; $ <= I; ++$) {
            const R = $ + w.ydisp, C = this._rowElements[$], A = w.lines.get(R);
            if (!C || !A) break;
            C.replaceChildren(...this._rowFactory.createRow(A, R, R === y, H, N, L, B, this.dimensions.css.cell.width, this._widthCache, P ? $ === T ? b : 0 : -1, P ? ($ === I ? x : U) - 1 : -1));
          }
        }
      };
      r.DomRenderer = D = l([f(7, a.IInstantiationService), f(8, i.ICharSizeService), f(9, a.IOptionsService), f(10, a.IBufferService), f(11, i.ICoreBrowserService), f(12, i.IThemeService)], D);
    }, 3787: function(O, r, o) {
      var l = this && this.__decorate || function(_, p, c, m) {
        var E, k = arguments.length, D = k < 3 ? p : m === null ? m = Object.getOwnPropertyDescriptor(p, c) : m;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") D = Reflect.decorate(_, p, c, m);
        else for (var b = _.length - 1; b >= 0; b--) (E = _[b]) && (D = (k < 3 ? E(D) : k > 3 ? E(p, c, D) : E(p, c)) || D);
      ...
      const n = o(2223), d = o(643), v = o(511), g = o(2585), h = o(8055), i = o(4725), s = o(4269), e = o(6171), t = o(3734);
      let a = r.DomRendererRowFactory = class {
        constructor(_, p, c, m, E, k, D) {
          this._document = _, this._characterJoinerService = p, this._optionsService = c, this._coreBrowserService = m, this._coreService = E, this._decorationService = k, this._themeService = D, this._workCell = new v.CellData(), this._columnSelectMode = false, this.defaultSpacing = 0;
        }
        handleSelectionChanged(_, p, c) {
          this._selectionStart = _, this._selectionEnd = p, this._columnSelectMode = c;
        }
        createRow(_, p, c, m, E, k, D, b, x, T, I) {
          const U = [], P = this._characterJoinerService.getJoinedCharacters(p), S = this._themeService.colors;
          let w, y = _.getNoBgTrimmedLength();
          c && y < k + 1 && (y = k + 1);
          let L = 0, B = "", H = 0, N = 0, $ = 0, R = false, C = 0, A = false, M = 0;
          const W = [], F = T !== -1 && I !== -1;
          for (let z = 0; z < y; z++) {
            ...
            const re = this._isCellInSelection(z, p), de = c && z === k, _e = F && z >= T && z <= I;
            let ue = false;
            this._decorationService.forEachDecorationAtCell(z, p, void 0, (K) => {
              ue = true;
            });
            let he = j.getChars() || d.WHITESPACE_CELL_CHAR;
            if (he === " " && (j.isUnderline() || j.isOverline()) && (he = "\xA0"), M = q * b - x.get(he, j.isBold(), j.isItalic()), w) {
              if (L && (re && A || !re && !A && j.bg === H) && (re && A && S.selectionForeground || j.fg === N) && j.extended.ext === $ && _e === R && M === C && !de && !V && !ue) {
                j.isInvisible() ? B += d.WHITESPACE_CELL_CHAR : B += he, L++;
                continue;
              }
              L && (w.textContent = B), w = this._document.createElement("span"), L = 0, B = "";
            } else w = this._document.createElement("span");
            if (H = j.bg, N = j.fg, $ = j.extended.ext, R = _e, C = M, A = re, V && k >= z && k <= X && (k = z), !this._coreService.isCursorHidden && de && this._coreService.isCursorInitialized) {
              if (W.push("xterm-cursor"), this._coreBrowserService.isFocused) D && W.push("xterm-cursor-blink"), W.push(m === "bar" ? "xterm-cursor-bar" : m === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
              else if (E) switch (E) {
                case "outline":
            ...
            if (j.isBold() && W.push("xterm-bold"), j.isItalic() && W.push("xterm-italic"), j.isDim() && W.push("xterm-dim"), B = j.isInvisible() ? d.WHITESPACE_CELL_CHAR : j.getChars() || d.WHITESPACE_CELL_CHAR, j.isUnderline() && (W.push(`xterm-underline-${j.extended.underlineStyle}`), B === " " && (B = "\xA0"), !j.isUnderlineColorDefault())) if (j.isUnderlineColorRGB()) w.style.textDecorationColor = `rgb(${t.AttributeData.toColorRGB(j.getUnderlineColor()).join(",")})`;
            else {
              let K = j.getUnderlineColor();
              this._optionsService.rawOptions.drawBoldTextInBrightColors && j.isBold() && K < 8 && (K += 8), w.style.textDecorationColor = S.ansi[K].css;
            }
            j.isOverline() && (W.push("xterm-overline"), B === " " && (B = "\xA0")), j.isStrikethrough() && W.push("xterm-strikethrough"), _e && (w.style.textDecoration = "underline");
            ...
            switch (this._decorationService.forEachDecorationAtCell(z, p, void 0, (K) => {
              ...
              case 33554432:
                ...
                break;
              case 50331648:
                ee = h.channels.toColor(Z >> 16, Z >> 8 & 255, 255 & Z), this._addStyle(w, `background-color:#${u((Z >>> 0).toString(16), "0", 6)}`);
                break;
              default:
            ...
            switch (Q || j.isDim() && (Q = h.color.multiplyOpacity(ee, 0.5)), ne) {
              case 16777216:
              case 33554432:
                j.isBold() && J < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (J += 8), this._applyMinimumContrast(w, ee, S.ansi[J], j, Q, void 0) || W.push(`xterm-fg-${J}`);
                break;
              case 50331648:
                const K = h.channels.toColor(J >> 16 & 255, J >> 8 & 255, 255 & J);
                this._applyMinimumContrast(w, ee, K, j, Q, ce) || this._addStyle(w, `color:#${u(J.toString(16), "0", 6)}`);
                break;
              default:
                this._applyMinimumContrast(w, ee, S.foreground, j, Q, ce) || fe && W.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`);
            }
            W.length && (w.className = W.join(" "), W.length = 0), de || V || ue ? w.textContent = B : L++, M !== this.defaultSpacing && (w.style.letterSpacing = `${M}px`), U.push(w), z = X;
          }
          return w && L && (w.textContent = B), U;
        }
        _applyMinimumContrast(_, p, c, m, E, k) {
          ...
          if (E || k || (b = D.getColor(p.rgba, c.rgba)), b === void 0) {
            ...
            b = h.color.ensureContrastRatio(E || p, k || c, x), D.setColor((E || p).rgba, (k || c).rgba, b ?? null);
          }
          return !!b && (this._addStyle(_, `color:${b.css}`), true);
        }
        _getContrastCache(_) {
      ...
      r.DomRendererRowFactory = a = l([f(1, i.ICharacterJoinerService), f(2, g.IOptionsService), f(3, i.ICoreBrowserService), f(4, g.ICoreService), f(5, g.IDecorationService), f(6, i.IThemeService)], a);
    }, 2550: (O, r) => {
      Object.defineProperty(r, "__esModule", { value: true }), r.WidthCache = void 0, r.WidthCache = class {
        ...
        get(o, l, f) {
          let n = 0;
          if (!l && !f && o.length === 1 && (n = o.charCodeAt(0)) < 256) {
          ...
          if (v === void 0) {
            let g = 0;
            l && (g |= 1), f && (g |= 2), v = this._measure(o, g), v > 0 && this._holey.set(d, v);
          }
          return v;
        }
        _measure(o, l) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.computeNextVariantOffset = r.createRenderDimensions = r.treatGlyphAsBackgroundColor = r.allowRescaling = r.isEmoji = r.isRestrictedPowerlineGlyph = r.isPowerlineGlyph = r.throwIfFalsy = void 0, r.throwIfFalsy = function(f) {
        ...
        return f;
      }, r.isPowerlineGlyph = o, r.isRestrictedPowerlineGlyph = function(f) {
        return 57520 <= f && f <= 57527;
      }, r.isEmoji = l, r.allowRescaling = function(f, n, d, v) {
        return n === 1 && d > Math.ceil(1.5 * v) && f !== void 0 && f > 255 && !l(f) && !o(f) && !function(g) {
          return 57344 <= g && g <= 63743;
        }(f);
      }, r.treatGlyphAsBackgroundColor = function(f) {
        return o(f) || function(n) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.SelectionModel = void 0, r.SelectionModel = class {
        constructor(o) {
          this._bufferService = o, this.isSelectAllActive = false, this.selectionStartLength = 0;
        }
        clearSelection() {
        ...
        handleTrim(o) {
          return this.selectionStart && (this.selectionStart[1] -= o), this.selectionEnd && (this.selectionEnd[1] -= o), this.selectionEnd && this.selectionEnd[1] < 0 ? (this.clearSelection(), true) : (this.selectionStart && this.selectionStart[1] < 0 && (this.selectionStart[1] = 0), false);
        }
      };
    }, 428: function(O, r, o) {
      var l = this && this.__decorate || function(e, t, a, u) {
      ...
      const n = o(2585), d = o(8460), v = o(844);
      ...
      const n = o(3734), d = o(643), v = o(511), g = o(2585);
      ...
      r.JoinedCellData = h;
      let i = r.CharacterJoinerService = class pe {
        constructor(e) {
        ...
        getJoinedCharacters(e) {
          ...
          const a = [], u = t.translateToString(true);
          let _ = 0, p = 0, c = 0, m = t.getFg(0), E = t.getBg(0);
          for (let k = 0; k < t.getTrimmedLength(); k++) if (t.loadCell(k, this._workCell), this._workCell.getWidth() !== 0) {
            if (this._workCell.fg !== m || this._workCell.bg !== E) {
              if (k - _ > 1) {
                const D = this._getJoinedRanges(u, c, p, t, _);
                for (let b = 0; b < D.length; b++) a.push(D[b]);
              }
              _ = k, c = p, m = this._workCell.fg, E = this._workCell.bg;
            }
        ...
        _getJoinedRanges(e, t, a, u, _) {
          ...
          for (let m = 1; m < this._characterJoiners.length; m++) try {
            ...
            for (let k = 0; k < E.length; k++) pe._mergeRanges(c, E[k]);
          } catch (E) {
            console.error(E);
          }
        ...
        _stringRangesToCellRanges(e, t, a) {
          ...
          if (c) {
            for (let m = a; m < this._bufferService.cols; m++) {
              const E = t.getWidth(m), k = t.getString(m).length || d.WHITESPACE_CELL_CHAR.length;
              if (E !== 0) {
        ...
        static _mergeRanges(e, t) {
          ...
          for (let u = 0; u < e.length; u++) {
            ...
            if (a) {
              ...
              t[0] < _[1] && (_[0] = Math.min(t[0], _[0]), a = true);
            }
          }
      ...
      const l = o(844), f = o(8460), n = o(3656);
      ...
      class v extends l.Disposable {
        ...
        _updateDpr() {
          var _a;
          this._outerListener && ((_a = this._resolutionMediaMatchList) == null ? void 0 : _a.removeListener(this._outerListener), this._currentDevicePixelRatio = this._parentWindow.devicePixelRatio, this._resolutionMediaMatchList = this._parentWindow.matchMedia(`screen and (resolution: ${this._parentWindow.devicePixelRatio}dppx)`), this._resolutionMediaMatchList.addListener(this._outerListener));
        }
        clearListener() {
      ...
      var l = this && this.__decorate || function(g, h, i, s) {
        ...
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") a = Reflect.decorate(g, h, i, s);
        else for (var u = g.length - 1; u >= 0; u--) (e = g[u]) && (a = (t < 3 ? e(a) : t > 3 ? e(h, i, a) : e(h, i)) || a);
      ...
      let v = r.MouseService = class {
        ...
        getCoords(g, h, i, s, e) {
          return (0, d.getCoords)(window, g, h, i, s, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, e);
        }
      ...
      let s = r.RenderService = class extends g.Disposable {
        ...
        refreshRows(e, t, a = false) {
          this._isPaused ? this._needsFullRefresh = true : (a || (this._isNextRenderRedrawOnly = false), this._renderDebouncer.refresh(e, t, this._rowCount));
        }
        _renderRows(e, t) {
        ...
        handleResize(e, t) {
          this._renderer.value && (this._isPaused ? this._pausedResizeTask.set(() => {
            var _a;
            return (_a = this._renderer.value) == null ? void 0 : _a.handleResize(e, t);
        ...
        handleSelectionChanged(e, t, a) {
          var _a;
          this._selectionState.start = e, this._selectionState.end = t, this._selectionState.columnSelectMode = a, (_a = this._renderer.value) == null ? void 0 : _a.handleSelectionChanged(e, t, a);
        }
        handleCursorMove() {
          var _a;
      ...
      var l = this && this.__decorate || function(c, m, E, k) {
        var D, b = arguments.length, x = b < 3 ? m : k === null ? k = Object.getOwnPropertyDescriptor(m, E) : k;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") x = Reflect.decorate(c, m, E, k);
        else for (var T = c.length - 1; T >= 0; T--) (D = c[T]) && (x = (b < 3 ? D(x) : b > 3 ? D(m, E, x) : D(m, E)) || x);
      ...
      let p = r.SelectionService = class extends i.Disposable {
        ...
        get selectionText() {
          const c = this._model.finalSelectionStart, m = this._model.finalSelectionEnd;
          if (!c || !m) return "";
          const E = this._bufferService.buffer, k = [];
          if (this._activeSelectionMode === 3) {
            if (c[0] === m[0]) return "";
            const D = c[0] < m[0] ? c[0] : m[0], b = c[0] < m[0] ? m[0] : c[0];
            for (let x = c[1]; x <= m[1]; x++) {
              const T = E.translateBufferLineToString(x, true, D, b);
              k.push(T);
            }
          } else {
            const D = c[1] === m[1] ? m[0] : void 0;
            k.push(E.translateBufferLineToString(c[1], true, c[0], D));
            for (let b = c[1] + 1; b <= m[1] - 1; b++) {
              const x = E.lines.get(b), T = E.translateBufferLineToString(b, true);
              (x == null ? void 0 : x.isWrapped) ? k[k.length - 1] += T : k.push(T);
            }
            if (c[1] !== m[1]) {
              const b = E.lines.get(m[1]), x = E.translateBufferLineToString(m[1], true, 0, m[0]);
              b && b.isWrapped ? k[k.length - 1] += x : k.push(x);
            }
          }
          return k.map((D) => D.replace(_, " ")).join(s.isWindows ? `\r
` : `
`);
        }
        clearSelection() {
        ...
        _isClickInSelection(c) {
          const m = this._getMouseBufferCoords(c), E = this._model.finalSelectionStart, k = this._model.finalSelectionEnd;
          return !!(E && k && m) && this._areCoordsInSelection(m, E, k);
        }
        isCellInSelection(c, m) {
          const E = this._model.finalSelectionStart, k = this._model.finalSelectionEnd;
          return !(!E || !k) && this._areCoordsInSelection([c, m], E, k);
        }
        _areCoordsInSelection(c, m, E) {
          return c[1] > m[1] && c[1] < E[1] || m[1] === E[1] && c[1] === m[1] && c[0] >= m[0] && c[0] < E[0] || m[1] < E[1] && c[1] === E[1] && c[0] < E[0] || m[1] < E[1] && c[1] === m[1] && c[0] >= m[0];
        }
        _selectWordAtCursor(c, m) {
          var _a, _b;
          const E = (_b = (_a = this._linkifier.currentLink) == null ? void 0 : _a.link) == null ? void 0 : _b.range;
          if (E) return this._model.selectionStart = [E.start.x - 1, E.start.y - 1], this._model.selectionStartLength = (0, e.getRangeLength)(E, this._bufferService.cols), this._model.selectionEnd = void 0, true;
        ...
        _getMouseEventScrollAmount(c) {
          ...
          return m >= 0 && m <= E ? 0 : (m > E && (m -= E), m = Math.min(Math.max(m, -50), 50), m /= 50, m / Math.abs(m) + Math.round(14 * m));
        }
        ...
        _handleMouseUp(c) {
          ...
          if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && m < 500 && c.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
            if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
              const E = this._mouseService.getCoords(c, this._element, this._bufferService.cols, this._bufferService.rows, false);
              if (E && E[0] !== void 0 && E[1] !== void 0) {
                const k = (0, d.moveToCellSequence)(E[0] - 1, E[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
        ...
        _fireEventIfSelectionChanged() {
          const c = this._model.finalSelectionStart, m = this._model.finalSelectionEnd, E = !(!c || !m || c[0] === m[0] && c[1] === m[1]);
          E ? c && m && (this._oldSelectionStart && this._oldSelectionEnd && c[0] === this._oldSelectionStart[0] && c[1] === this._oldSelectionStart[1] && m[0] === this._oldSelectionEnd[0] && m[1] === this._oldSelectionEnd[1] || this._fireOnSelectionChange(c, m, E)) : this._oldHasSelection && this._fireOnSelectionChange(c, m, E);
        }
        _fireOnSelectionChange(c, m, E) {
          this._oldSelectionStart = c, this._oldSelectionEnd = m, this._oldHasSelection = E, this._onSelectionChange.fire();
        }
        ...
        setSelection(c, m, E) {
          this._model.clearSelection(), this._removeMouseDownListeners(), this._model.selectionStart = [c, m], this._model.selectionStartLength = E, this.refresh(), this._fireEventIfSelectionChanged();
        }
        rightClickSelect(c) {
          this._isClickInSelection(c) || (this._selectWordAtCursor(c, false) && this.refresh(true), this._fireEventIfSelectionChanged());
        }
        _getWordAt(c, m, E = true, k = true) {
          if (c[0] >= this._bufferService.cols) return;
          const D = this._bufferService.buffer, b = D.lines.get(c[1]);
          if (!b) return;
          const x = D.translateBufferLineToString(c[1], false);
          let T = this._convertViewportColToCharacterIndex(b, c[0]), I = T;
          const U = c[0] - T;
          let P = 0, S = 0, w = 0, y = 0;
          if (x.charAt(T) === " ") {
            ...
            for ($ > 1 && (y += $ - 1, I += $ - 1); H > 0 && T > 0 && !this._isCharWordSeparator(b.loadCell(H - 1, this._workCell)); ) {
              b.loadCell(H - 1, this._workCell);
              const R = this._workCell.getChars().length;
              this._workCell.getWidth() === 0 ? (P++, H--) : R > 1 && (w += R - 1, T -= R - 1), T--, H--;
            }
            for (; N < b.length && I + 1 < x.length && !this._isCharWordSeparator(b.loadCell(N + 1, this._workCell)); ) {
              b.loadCell(N + 1, this._workCell);
              const R = this._workCell.getChars().length;
              this._workCell.getWidth() === 2 ? (S++, N++) : R > 1 && (y += R - 1, I += R - 1), I++, N++;
            }
          }
          I++;
          let L = T + U - P + w, B = Math.min(this._bufferService.cols, I - T + P + S - w - y);
          if (m || x.slice(T, I).trim() !== "") {
            if (E && L === 0 && b.getCodePoint(0) !== 32) {
              const H = D.lines.get(c[1] - 1);
              if (H && b.isWrapped && H.getCodePoint(this._bufferService.cols - 1) !== 32) {
            ...
            if (k && L + B === this._bufferService.cols && b.getCodePoint(this._bufferService.cols - 1) !== 32) {
              const H = D.lines.get(c[1] + 1);
              if ((H == null ? void 0 : H.isWrapped) && H.getCodePoint(0) !== 32) {
        ...
        _selectWordAt(c, m) {
          ...
          if (E) {
            ...
            this._model.selectionStart = [E.start, c[1]], this._model.selectionStartLength = E.length;
          }
        }
        _selectToWordAt(c) {
          ...
          if (m) {
            ...
            if (!this._model.areSelectionValuesReversed()) for (; m.start + m.length > this._bufferService.cols; ) m.length -= this._bufferService.cols, E++;
            this._model.selectionEnd = [this._model.areSelectionValuesReversed() ? m.start : m.start + m.length, E];
          }
        }
        ...
        _selectLineAt(c) {
          const m = this._bufferService.buffer.getWrappedRangeForLine(c), E = { start: { x: 0, y: m.first }, end: { x: this._bufferService.cols - 1, y: m.last } };
          this._model.selectionStart = [0, m.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = (0, e.getRangeLength)(E, this._bufferService.cols);
        }
      };
      r.SelectionService = p = l([f(3, a.IBufferService), f(4, a.ICoreService), f(5, g.IMouseService), f(6, a.IOptionsService), f(7, g.IRenderService), f(8, g.ICoreBrowserService)], p);
    }, 4725: (O, r, o) => {
      ...
      var l = this && this.__decorate || function(p, c, m, E) {
        var k, D = arguments.length, b = D < 3 ? c : E === null ? E = Object.getOwnPropertyDescriptor(c, m) : E;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") b = Reflect.decorate(p, c, m, E);
        else for (var x = p.length - 1; x >= 0; x--) (k = p[x]) && (b = (D < 3 ? k(b) : D > 3 ? k(c, m, b) : k(c, m)) || b);
      ...
      const n = o(7239), d = o(8055), v = o(8460), g = o(844), h = o(2585), i = d.css.toColor("#ffffff"), s = d.css.toColor("#000000"), e = d.css.toColor("#ffffff"), t = d.css.toColor("#000000"), a = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
      r.DEFAULT_ANSI_COLORS = Object.freeze((() => {
        ...
        for (let m = 0; m < 216; m++) {
          const E = c[m / 36 % 6 | 0], k = c[m / 6 % 6 | 0], D = c[m % 6];
          p.push({ css: d.channels.toCss(E, k, D), rgba: d.channels.toRgba(E, k, D) });
        }
        for (let m = 0; m < 24; m++) {
          const E = 8 + 10 * m;
          p.push({ css: d.channels.toCss(E, E, E), rgba: d.channels.toRgba(E, E, E) });
        }
        return p;
      })());
      let u = r.ThemeService = class extends g.Disposable {
        ...
        _setTheme(p = {}) {
          ...
          if (c.foreground = _(p.foreground, i), c.background = _(p.background, s), c.cursor = _(p.cursor, e), c.cursorAccent = _(p.cursorAccent, t), c.selectionBackgroundTransparent = _(p.selectionBackground, a), c.selectionBackgroundOpaque = d.color.blend(c.background, c.selectionBackgroundTransparent), c.selectionInactiveBackgroundTransparent = _(p.selectionInactiveBackground, c.selectionBackgroundTransparent), c.selectionInactiveBackgroundOpaque = d.color.blend(c.background, c.selectionInactiveBackgroundTransparent), c.selectionForeground = p.selectionForeground ? _(p.selectionForeground, d.NULL_COLOR) : void 0, c.selectionForeground === d.NULL_COLOR && (c.selectionForeground = void 0), d.color.isOpaque(c.selectionBackgroundTransparent) && (c.selectionBackgroundTransparent = d.color.opacity(c.selectionBackgroundTransparent, 0.3)), d.color.isOpaque(c.selectionInactiveBackgroundTransparent) && (c.selectionInactiveBackgroundTransparent = d.color.opacity(c.selectionInactiveBackgroundTransparent, 0.3)), c.ansi = r.DEFAULT_ANSI_COLORS.slice(), c.ansi[0] = _(p.black, r.DEFAULT_ANSI_COLORS[0]), c.ansi[1] = _(p.red, r.DEFAULT_ANSI_COLORS[1]), c.ansi[2] = _(p.green, r.DEFAULT_ANSI_COLORS[2]), c.ansi[3] = _(p.yellow, r.DEFAULT_ANSI_COLORS[3]), c.ansi[4] = _(p.blue, r.DEFAULT_ANSI_COLORS[4]), c.ansi[5] = _(p.magenta, r.DEFAULT_ANSI_COLORS[5]), c.ansi[6] = _(p.cyan, r.DEFAULT_ANSI_COLORS[6]), c.ansi[7] = _(p.white, r.DEFAULT_ANSI_COLORS[7]), c.ansi[8] = _(p.brightBlack, r.DEFAULT_ANSI_COLORS[8]), c.ansi[9] = _(p.brightRed, r.DEFAULT_ANSI_COLORS[9]), c.ansi[10] = _(p.brightGreen, r.DEFAULT_ANSI_COLORS[10]), c.ansi[11] = _(p.brightYellow, r.DEFAULT_ANSI_COLORS[11]), c.ansi[12] = _(p.brightBlue, r.DEFAULT_ANSI_COLORS[12]), c.ansi[13] = _(p.brightMagenta, r.DEFAULT_ANSI_COLORS[13]), c.ansi[14] = _(p.brightCyan, r.DEFAULT_ANSI_COLORS[14]), c.ansi[15] = _(p.brightWhite, r.DEFAULT_ANSI_COLORS[15]), p.extendedAnsi) {
            ...
            for (let E = 0; E < m; E++) c.ansi[E + 16] = _(p.extendedAnsi[E], r.DEFAULT_ANSI_COLORS[E + 16]);
          }
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.clone = void 0, r.clone = function o(l, f = 5) {
        if (typeof l != "object") return l;
        const n = Array.isArray(l) ? [] : {};
        for (const d in l) n[d] = f <= 1 ? l[d] : l[d] && o(l[d], f - 1);
        return n;
      };
    }, 8055: (O, r) => {
      ...
      r.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(t) {
        t.toCss = function(a, u, _, p) {
          return p !== void 0 ? `#${s(a)}${s(u)}${s(_)}${s(p)}` : `#${s(a)}${s(u)}${s(_)}`;
        }, t.toRgba = function(a, u, _, p = 255) {
          return (a << 24 | u << 16 | _ << 8 | p) >>> 0;
        }, t.toColor = function(a, u, _, p) {
          return { css: t.toCss(a, u, _, p), rgba: t.toRgba(a, u, _, p) };
        };
      }(d || (r.channels = d = {})), function(t) {
        function a(u, _) {
          return n = Math.round(255 * _), [o, l, f] = i.toChannels(u.rgba), { css: d.toCss(o, l, f, n), rgba: d.toRgba(o, l, f, n) };
        }
        t.blend = function(u, _) {
          if (n = (255 & _.rgba) / 255, n === 1) return { css: _.css, rgba: _.rgba };
          const p = _.rgba >> 24 & 255, c = _.rgba >> 16 & 255, m = _.rgba >> 8 & 255, E = u.rgba >> 24 & 255, k = u.rgba >> 16 & 255, D = u.rgba >> 8 & 255;
          return o = E + Math.round((p - E) * n), l = k + Math.round((c - k) * n), f = D + Math.round((m - D) * n), { css: d.toCss(o, l, f), rgba: d.toRgba(o, l, f) };
          ...
          return [o, l, f] = i.toChannels(_), { css: d.toCss(o, l, f), rgba: _ };
        }, t.opacity = a, t.multiplyOpacity = function(u, _) {
          return n = 255 & u.rgba, a(u, n * _ / 255);
        ...
        try {
          ...
          p && (a = p, a.globalCompositeOperation = "copy", u = a.createLinearGradient(0, 0, 1, 1));
        } catch {
        }
        t.toColor = function(_) {
          if (_.match(/#[\da-f]{3,8}/i)) switch (_.length) {
            case 4:
              return o = parseInt(_.slice(1, 2).repeat(2), 16), l = parseInt(_.slice(2, 3).repeat(2), 16), f = parseInt(_.slice(3, 4).repeat(2), 16), d.toColor(o, l, f);
            case 5:
              return o = parseInt(_.slice(1, 2).repeat(2), 16), l = parseInt(_.slice(2, 3).repeat(2), 16), f = parseInt(_.slice(3, 4).repeat(2), 16), n = parseInt(_.slice(4, 5).repeat(2), 16), d.toColor(o, l, f, n);
            case 7:
          ...
          if (p) return o = parseInt(p[1]), l = parseInt(p[2]), f = parseInt(p[3]), n = Math.round(255 * (p[5] === void 0 ? 1 : parseFloat(p[5]))), d.toColor(o, l, f, n);
          if (!a || !u) throw new Error("css.toColor: Unsupported css format");
          if (a.fillStyle = u, a.fillStyle = _, typeof a.fillStyle != "string") throw new Error("css.toColor: Unsupported css format");
          if (a.fillRect(0, 0, 1, 1), [o, l, f, n] = a.getImageData(0, 0, 1, 1).data, n !== 255) throw new Error("css.toColor: Unsupported css format");
          return { rgba: d.toRgba(o, l, f, n), css: _ };
        };
      }(g || (r.css = g = {})), function(t) {
        function a(u, _, p) {
          const c = u / 255, m = _ / 255, E = p / 255;
          return 0.2126 * (c <= 0.03928 ? c / 12.92 : Math.pow((c + 0.055) / 1.055, 2.4)) + 0.7152 * (m <= 0.03928 ? m / 12.92 : Math.pow((m + 0.055) / 1.055, 2.4)) + 0.0722 * (E <= 0.03928 ? E / 12.92 : Math.pow((E + 0.055) / 1.055, 2.4));
        }
        t.relativeLuminance = function(u) {
          return a(u >> 16 & 255, u >> 8 & 255, 255 & u);
        }, t.relativeLuminance2 = a;
      }(h || (r.rgb = h = {})), function(t) {
        function a(_, p, c) {
          const m = _ >> 24 & 255, E = _ >> 16 & 255, k = _ >> 8 & 255;
          let D = p >> 24 & 255, b = p >> 16 & 255, x = p >> 8 & 255, T = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
          for (; T < c && (D > 0 || b > 0 || x > 0); ) D -= Math.max(0, Math.ceil(0.1 * D)), b -= Math.max(0, Math.ceil(0.1 * b)), x -= Math.max(0, Math.ceil(0.1 * x)), T = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
          return (D << 24 | b << 16 | x << 8 | 255) >>> 0;
        }
        function u(_, p, c) {
          const m = _ >> 24 & 255, E = _ >> 16 & 255, k = _ >> 8 & 255;
          let D = p >> 24 & 255, b = p >> 16 & 255, x = p >> 8 & 255, T = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
          for (; T < c && (D < 255 || b < 255 || x < 255); ) D = Math.min(255, D + Math.ceil(0.1 * (255 - D))), b = Math.min(255, b + Math.ceil(0.1 * (255 - b))), x = Math.min(255, x + Math.ceil(0.1 * (255 - x))), T = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
          return (D << 24 | b << 16 | x << 8 | 255) >>> 0;
        }
        t.blend = function(_, p) {
          if (n = (255 & p) / 255, n === 1) return p;
          const c = p >> 24 & 255, m = p >> 16 & 255, E = p >> 8 & 255, k = _ >> 24 & 255, D = _ >> 16 & 255, b = _ >> 8 & 255;
          return o = k + Math.round((c - k) * n), l = D + Math.round((m - D) * n), f = b + Math.round((E - b) * n), d.toRgba(o, l, f);
        }, t.ensureContrastRatio = function(_, p, c) {
          const m = h.relativeLuminance(_ >> 8), E = h.relativeLuminance(p >> 8);
          if (e(m, E) < c) {
            if (E < m) {
              const b = a(_, p, c), x = e(m, h.relativeLuminance(b >> 8));
              if (x < c) {
                const T = u(_, p, c);
                return x > e(m, h.relativeLuminance(T >> 8)) ? b : T;
              }
              return b;
            }
            const k = u(_, p, c), D = e(m, h.relativeLuminance(k >> 8));
            if (D < c) {
              const b = a(_, p, c);
        ...
        }, t.reduceLuminance = a, t.increaseLuminance = u, t.toChannels = function(_) {
      ...
      const l = o(844), f = o(2585), n = o(4348), d = o(7866), v = o(744), g = o(7302), h = o(6975), i = o(8460), s = o(1753), e = o(1480), t = o(7994), a = o(9282), u = o(5435), _ = o(5981), p = o(2660);
      let c = false;
      class m extends l.Disposable {
        get onScroll() {
          return this._onScrollApi || (this._onScrollApi = this.register(new i.EventEmitter()), this._onScroll.event((k) => {
            var _a;
            (_a = this._onScrollApi) == null ? void 0 : _a.fire(k.position);
        ...
        constructor(k) {
          super(), this._windowsWrappingHeuristics = this.register(new l.MutableDisposable()), this._onBinary = this.register(new i.EventEmitter()), this.onBinary = this._onBinary.event, this._onData = this.register(new i.EventEmitter()), this.onData = this._onData.event, this._onLineFeed = this.register(new i.EventEmitter()), this.onLineFeed = this._onLineFeed.event, this._onResize = this.register(new i.EventEmitter()), this.onResize = this._onResize.event, this._onWriteParsed = this.register(new i.EventEmitter()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this.register(new i.EventEmitter()), this._instantiationService = new n.InstantiationService(), this.optionsService = this.register(new g.OptionsService(k)), this._instantiationService.setService(f.IOptionsService, this.optionsService), this._bufferService = this.register(this._instantiationService.createInstance(v.BufferService)), this._instantiationService.setService(f.IBufferService, this._bufferService), this._logService = this.register(this._instantiationService.createInstance(d.LogService)), this._instantiationService.setService(f.ILogService, this._logService), this.coreService = this.register(this._instantiationService.createInstance(h.CoreService)), this._instantiationService.setService(f.ICoreService, this.coreService), this.coreMouseService = this.register(this._instantiationService.createInstance(s.CoreMouseService)), this._instantiationService.setService(f.ICoreMouseService, this.coreMouseService), this.unicodeService = this.register(this._instantiationService.createInstance(e.UnicodeService)), this._instantiationService.setService(f.IUnicodeService, this.unicodeService), this._charsetService = this._instantiationService.createInstance(t.CharsetService), this._instantiationService.setService(f.ICharsetService, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(p.OscLinkService), this._instantiationService.setService(f.IOscLinkService, this._oscLinkService), this._inputHandler = this.register(new u.InputHandler(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this.register((0, i.forwardEvent)(this._inputHandler.onLineFeed, this._onLineFeed)), this.register(this._inputHandler), this.register((0, i.forwardEvent)(this._bufferService.onResize, this._onResize)), this.register((0, i.forwardEvent)(this.coreService.onData, this._onData)), this.register((0, i.forwardEvent)(this.coreService.onBinary, this._onBinary)), this.register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom())), this.register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this.register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this.register(this._bufferService.onScroll((D) => {
            ...
            this._onScroll.fire({ position: this._bufferService.buffer.ydisp, source: 0 }), this._inputHandler.markRangeDirty(this._bufferService.buffer.scrollTop, this._bufferService.buffer.scrollBottom);
          })), this._writeBuffer = this.register(new _.WriteBuffer((D, b) => this._inputHandler.parse(D, b))), this.register((0, i.forwardEvent)(this._writeBuffer.onWriteParsed, this._onWriteParsed));
        }
        write(k, D) {
          this._writeBuffer.write(k, D);
        }
        writeSync(k, D) {
          this._logService.logLevel <= f.LogLevelEnum.WARN && !c && (this._logService.warn("writeSync is unreliable and will be removed soon."), c = true), this._writeBuffer.writeSync(k, D);
        }
        input(k, D = true) {
          this.coreService.triggerDataEvent(k, D);
        }
        resize(k, D) {
          isNaN(k) || isNaN(D) || (k = Math.max(k, v.MINIMUM_COLS), D = Math.max(D, v.MINIMUM_ROWS), this._bufferService.resize(k, D));
        }
        scroll(k, D = false) {
        ...
        _handleWindowsPtyOptionChange() {
          ...
          D && D.buildNumber !== void 0 && D.buildNumber !== void 0 ? k = D.backend === "conpty" && D.buildNumber < 21376 : this.optionsService.rawOptions.windowsMode && (k = true), k ? this._enableWindowsWrappingHeuristics() : this._windowsWrappingHeuristics.clear();
        }
        _enableWindowsWrappingHeuristics() {
          if (!this._windowsWrappingHeuristics.value) {
            const k = [];
            k.push(this.onLineFeed(a.updateWindowsModeWrappedState.bind(null, this._bufferService))), k.push(this.registerCsiHandler({ final: "H" }, () => ((0, a.updateWindowsModeWrappedState)(this._bufferService), false))), this._windowsWrappingHeuristics.value = (0, l.toDisposable)(() => {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.runAndSubscribe = r.forwardEvent = r.EventEmitter = void 0, r.EventEmitter = class {
        ...
        fire(o, l) {
          ...
          for (let n = 0; n < f.length; n++) f[n].call(void 0, o, l);
        }
        dispose() {
        ...
        return l(void 0), o((f) => l(f));
      };
    }, 5435: function(O, r, o) {
      var l = this && this.__decorate || function(P, S, w, y) {
        var L, B = arguments.length, H = B < 3 ? S : y === null ? y = Object.getOwnPropertyDescriptor(S, w) : y;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") H = Reflect.decorate(P, S, w, y);
        else for (var N = P.length - 1; N >= 0; N--) (L = P[N]) && (H = (B < 3 ? L(H) : B > 3 ? L(S, w, H) : L(S, w)) || H);
      ...
      const n = o(2584), d = o(7116), v = o(2015), g = o(844), h = o(482), i = o(8437), s = o(8460), e = o(643), t = o(511), a = o(3734), u = o(2585), _ = o(1480), p = o(6242), c = o(6351), m = o(5941), E = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, k = 131072;
      function D(P, S) {
        if (P > 24) return S.setWinLines || false;
        switch (P) {
          case 1:
            return !!S.restoreWin;
          case 2:
      ...
      class T extends g.Disposable {
        ...
        parse(S, w) {
          let y, L = this._activeBuffer.x, B = this._activeBuffer.y, H = 0;
          const N = this._parseStack.paused;
          if (N) {
            if (y = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, w)) return this._logSlowResolvingAsync(y), y;
            L = this._parseStack.cursorStartX, B = this._parseStack.cursorStartY, this._parseStack.paused = false, S.length > k && (H = this._parseStack.position + k);
          }
          if (this._logService.logLevel <= u.LogLevelEnum.DEBUG && this._logService.debug("parsing data" + (typeof S == "string" ? ` "${S}"` : ` "${Array.prototype.map.call(S, (C) => String.fromCharCode(C)).join("")}"`), typeof S == "string" ? S.split("").map((C) => C.charCodeAt(0)) : S), this._parseBuffer.length < S.length && this._parseBuffer.length < k && (this._parseBuffer = new Uint32Array(Math.min(S.length, k))), N || this._dirtyRowTracker.clearRange(), S.length > k) for (let C = H; C < S.length; C += k) {
            const A = C + k < S.length ? C + k : S.length, M = typeof S == "string" ? this._stringDecoder.decode(S.substring(C, A), this._parseBuffer) : this._utf8Decoder.decode(S.subarray(C, A), this._parseBuffer);
            if (y = this._parser.parse(this._parseBuffer, M)) return this._preserveStack(L, B, M, C), this._logSlowResolvingAsync(y), y;
          }
          else if (!N) {
            const C = typeof S == "string" ? this._stringDecoder.decode(S, this._parseBuffer) : this._utf8Decoder.decode(S, this._parseBuffer);
            if (y = this._parser.parse(this._parseBuffer, C)) return this._preserveStack(L, B, C, 0), this._logSlowResolvingAsync(y), y;
          }
          this._activeBuffer.x === L && this._activeBuffer.y === B || this._onCursorMove.fire();
        ...
        print(S, w, y) {
          let L, B;
          const H = this._charsetService.charset, N = this._optionsService.rawOptions.screenReaderMode, $ = this._bufferService.cols, R = this._coreService.decPrivateModes.wraparound, C = this._coreService.modes.insertMode, A = this._curAttrData;
          let M = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && y - w > 0 && M.getWidth(this._activeBuffer.x - 1) === 2 && M.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, A);
          ...
          for (let F = w; F < y; ++F) {
            ...
            B = _.UnicodeService.extractWidth(z);
            const q = _.UnicodeService.extractShouldJoin(z), V = q ? _.UnicodeService.extractWidth(W) : 0;
            if (W = z, N && this._onA11yChar.fire((0, h.stringFromCodePoint)(L)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + B - V > $) {
              if (R) {
                const X = M;
                let j = this._activeBuffer.x - V;
                for (this._activeBuffer.x = V, this._activeBuffer.y++, this._activeBuffer.y === this._activeBuffer.scrollBottom + 1 ? (this._activeBuffer.y--, this._bufferService.scroll(this._eraseAttrData(), true)) : (this._activeBuffer.y >= this._bufferService.rows && (this._activeBuffer.y = this._bufferService.rows - 1), this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = true), M = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y), V > 0 && M instanceof i.BufferLine && M.copyCellsFrom(X, j, 0, V, false); j < $; ) X.setCellFromCodepoint(j++, 0, 1, A);
              } else if (this._activeBuffer.x = $ - 1, B === 2) continue;
            }
            if (q && this._activeBuffer.x) {
              const X = M.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
              M.addCodepointToCell(this._activeBuffer.x - X, L, B);
              for (let j = B - V; --j >= 0; ) M.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, A);
            } else if (C && (M.insertCells(this._activeBuffer.x, B - V, this._activeBuffer.getNullCell(A)), M.getWidth($ - 1) === 2 && M.setCellFromCodepoint($ - 1, e.NULL_CELL_CODE, e.NULL_CELL_WIDTH, A)), M.setCellFromCodepoint(this._activeBuffer.x++, L, B, A), B > 0) for (; --B; ) M.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, A);
          }
          this._parser.precedingJoinState = W, this._activeBuffer.x < $ && y - w > 0 && M.getWidth(this._activeBuffer.x) === 0 && !M.hasContent(this._activeBuffer.x) && M.setCellFromCodepoint(this._activeBuffer.x, 0, 1, A), this._dirtyRowTracker.markDirty(this._activeBuffer.y);
        }
        registerCsiHandler(S, w) {
          return S.final !== "t" || S.prefix || S.intermediates ? this._parser.registerCsiHandler(S, w) : this._parser.registerCsiHandler(S, (y) => !D(y.params[0], this._optionsService.rawOptions.windowOptions) || w(y));
        }
        ...
        backspace() {
          ...
          else if (this._activeBuffer.x === 0 && this._activeBuffer.y > this._activeBuffer.scrollTop && this._activeBuffer.y <= this._activeBuffer.scrollBottom && ((_a = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y)) == null ? void 0 : _a.isWrapped)) {
            this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = false, this._activeBuffer.y--, this._activeBuffer.x = this._bufferService.cols - 1;
            const S = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
            S.hasWidth(this._activeBuffer.x) && !S.hasContent(this._activeBuffer.x) && this._activeBuffer.x--;
          }
        ...
        cursorUp(S) {
          ...
          return w >= 0 ? this._moveCursor(0, -Math.min(w, S.params[0] || 1)) : this._moveCursor(0, -(S.params[0] || 1)), true;
        }
        cursorDown(S) {
        ...
        tabClear(S) {
          const w = S.params[0];
          return w === 0 ? delete this._activeBuffer.tabs[this._activeBuffer.x] : w === 3 && (this._activeBuffer.tabs = {}), true;
        }
        cursorForwardTab(S) {
          if (this._activeBuffer.x >= this._bufferService.cols) return true;
          let w = S.params[0] || 1;
        ...
        selectProtected(S) {
          const w = S.params[0];
          return w === 1 && (this._curAttrData.bg |= 536870912), w !== 2 && w !== 0 || (this._curAttrData.bg &= -536870913), true;
        }
        _eraseInBufferLine(S, w, y, L = false, B = false) {
          const H = this._activeBuffer.lines.get(this._activeBuffer.ybase + S);
          H.replaceCells(w, y, this._activeBuffer.getNullCell(this._eraseAttrData()), B), L && (H.isWrapped = false);
        }
        _resetBufferLine(S, w = false) {
          const y = this._activeBuffer.lines.get(this._activeBuffer.ybase + S);
          y && (y.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), w), this._bufferService.buffer.clearMarkers(this._activeBuffer.ybase + S), y.isWrapped = false);
        }
        eraseInDisplay(S, w = false) {
          let y;
          switch (this._restrictCursor(this._bufferService.cols), S.params[0]) {
            case 0:
              for (y = this._activeBuffer.y, this._dirtyRowTracker.markDirty(y), this._eraseInBufferLine(y++, this._activeBuffer.x, this._bufferService.cols, this._activeBuffer.x === 0, w); y < this._bufferService.rows; y++) this._resetBufferLine(y, w);
              this._dirtyRowTracker.markDirty(y);
              break;
            case 1:
              for (y = this._activeBuffer.y, this._dirtyRowTracker.markDirty(y), this._eraseInBufferLine(y, 0, this._activeBuffer.x + 1, true, w), this._activeBuffer.x + 1 >= this._bufferService.cols && (this._activeBuffer.lines.get(y + 1).isWrapped = false); y--; ) this._resetBufferLine(y, w);
              this._dirtyRowTracker.markDirty(0);
              break;
            case 2:
              for (y = this._bufferService.rows, this._dirtyRowTracker.markDirty(y - 1); y--; ) this._resetBufferLine(y, w);
              this._dirtyRowTracker.markDirty(0);
              break;
            case 3:
        ...
        eraseInLine(S, w = false) {
          switch (this._restrictCursor(this._bufferService.cols), S.params[0]) {
            case 0:
              this._eraseInBufferLine(this._activeBuffer.y, this._activeBuffer.x, this._bufferService.cols, this._activeBuffer.x === 0, w);
              break;
            case 1:
              this._eraseInBufferLine(this._activeBuffer.y, 0, this._activeBuffer.x + 1, false, w);
              break;
            case 2:
              this._eraseInBufferLine(this._activeBuffer.y, 0, this._bufferService.cols, true, w);
          }
        ...
        insertLines(S) {
          ...
          const y = this._activeBuffer.ybase + this._activeBuffer.y, L = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, B = this._bufferService.rows - 1 + this._activeBuffer.ybase - L + 1;
          for (; w--; ) this._activeBuffer.lines.splice(B - 1, 1), this._activeBuffer.lines.splice(y, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
        ...
        deleteLines(S) {
          ...
          let L;
          for (L = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, L = this._bufferService.rows - 1 + this._activeBuffer.ybase - L; w--; ) this._activeBuffer.lines.splice(y, 1), this._activeBuffer.lines.splice(L, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.y, this._activeBuffer.scrollBottom), this._activeBuffer.x = 0, true;
        }
        insertChars(S) {
          this._restrictCursor();
          const w = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return w && (w.insertCells(this._activeBuffer.x, S.params[0] || 1, this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), true;
        }
        deleteChars(S) {
          this._restrictCursor();
          const w = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return w && (w.deleteCells(this._activeBuffer.x, S.params[0] || 1, this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), true;
        }
        scrollUp(S) {
          let w = S.params[0] || 1;
        ...
        scrollLeft(S) {
          ...
          for (let y = this._activeBuffer.scrollTop; y <= this._activeBuffer.scrollBottom; ++y) {
            ...
            L.deleteCells(0, w, this._activeBuffer.getNullCell(this._eraseAttrData())), L.isWrapped = false;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), true;
        }
        scrollRight(S) {
          ...
          for (let y = this._activeBuffer.scrollTop; y <= this._activeBuffer.scrollBottom; ++y) {
            const L = this._activeBuffer.lines.get(this._activeBuffer.ybase + y);
            L.insertCells(0, w, this._activeBuffer.getNullCell(this._eraseAttrData())), L.isWrapped = false;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), true;
        }
        insertColumns(S) {
          ...
          for (let y = this._activeBuffer.scrollTop; y <= this._activeBuffer.scrollBottom; ++y) {
            const L = this._activeBuffer.lines.get(this._activeBuffer.ybase + y);
            L.insertCells(this._activeBuffer.x, w, this._activeBuffer.getNullCell(this._eraseAttrData())), L.isWrapped = false;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), true;
        }
        deleteColumns(S) {
          ...
          for (let y = this._activeBuffer.scrollTop; y <= this._activeBuffer.scrollBottom; ++y) {
            const L = this._activeBuffer.lines.get(this._activeBuffer.ybase + y);
            L.deleteCells(this._activeBuffer.x, w, this._activeBuffer.getNullCell(this._eraseAttrData())), L.isWrapped = false;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), true;
        }
        eraseChars(S) {
          this._restrictCursor();
          const w = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return w && (w.replaceCells(this._activeBuffer.x, this._activeBuffer.x + (S.params[0] || 1), this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), true;
        }
        repeatPrecedingCharacter(S) {
          const w = this._parser.precedingJoinState;
          if (!w) return true;
          const y = S.params[0] || 1, L = _.UnicodeService.extractWidth(w), B = this._activeBuffer.x - L, H = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(B), N = new Uint32Array(H.length * y);
          let $ = 0;
        ...
        resetModePrivate(S) {
          for (let w = 0; w < S.length; w++) switch (S.params[w]) {
            ...
            case 47:
            case 1047:
              this._bufferService.buffers.activateNormalBuffer(), S.params[w] === 1049 && this.restoreCursor(), this._coreService.isCursorInitialized = true, this._onRequestRefreshRows.fire(0, this._bufferService.rows - 1), this._onRequestSyncScrollBar.fire();
              break;
            case 2004:
        ...
        requestMode(S, w) {
          const y = this._coreService.decPrivateModes, { activeProtocol: L, activeEncoding: B } = this._coreMouseService, H = this._coreService, { buffers: N, cols: $ } = this._bufferService, { active: R, alt: C } = N, A = this._optionsService.rawOptions, M = (q) => q ? 1 : 2, W = S.params[0];
          return F = W, z = w ? W === 2 ? 4 : W === 4 ? M(H.modes.insertMode) : W === 12 ? 3 : W === 20 ? M(A.convertEol) : 0 : W === 1 ? M(y.applicationCursorKeys) : W === 3 ? A.windowOptions.setWinLines ? $ === 80 ? 2 : $ === 132 ? 1 : 0 : 0 : W === 6 ? M(y.origin) : W === 7 ? M(y.wraparound) : W === 8 ? 3 : W === 9 ? M(L === "X10") : W === 12 ? M(A.cursorBlink) : W === 25 ? M(!H.isCursorHidden) : W === 45 ? M(y.reverseWraparound) : W === 66 ? M(y.applicationKeypad) : W === 67 ? 4 : W === 1e3 ? M(L === "VT200") : W === 1002 ? M(L === "DRAG") : W === 1003 ? M(L === "ANY") : W === 1004 ? M(y.sendFocus) : W === 1005 ? 4 : W === 1006 ? M(B === "SGR") : W === 1015 ? 4 : W === 1016 ? M(B === "SGR_PIXELS") : W === 1048 ? 1 : W === 47 || W === 1047 || W === 1049 ? M(R === C) : W === 2004 ? M(y.bracketedPasteMode) : 0, H.triggerDataEvent(`${n.C0.ESC}[${w ? "" : "?"}${F};${z}$y`), true;
          var F, z;
        }
        _updateAttrColor(S, w, y, L, B) {
          return w === 2 ? (S |= 50331648, S &= -16777216, S |= a.AttributeData.fromColorRGB([y, L, B])) : w === 5 && (S &= -50331904, S |= 33554432 | 255 & y), S;
        }
        _extractColor(S, w, y) {
          const L = [0, 0, -1, 0, 0, 0];
          let B = 0, H = 0;
          ...
          switch (L[0]) {
            ...
            case 48:
              ...
              break;
            case 58:
              y.extended = y.extended.clone(), y.extended.underlineColor = this._updateAttrColor(y.extended.underlineColor, L[1], L[3], L[4], L[5]);
          }
          return H;
        }
        ...
        deviceStatus(S) {
          switch (S.params[0]) {
            case 5:
              ...
              break;
            case 6:
              const w = this._activeBuffer.y + 1, y = this._activeBuffer.x + 1;
        ...
        setCursorStyle(S) {
          ...
          const y = w % 2 == 1;
          return this._optionsService.options.cursorBlink = y, true;
        }
        setScrollRegion(S) {
          const w = S.params[0] || 1;
          let y;
          return (S.length < 2 || (y = S.params[1]) > this._bufferService.rows || y === 0) && (y = this._bufferService.rows), y > w && (this._activeBuffer.scrollTop = w - 1, this._activeBuffer.scrollBottom = y - 1, this._setCursor(0, 0)), true;
        }
        windowOptions(S) {
          if (!D(S.params[0], this._optionsService.rawOptions.windowOptions)) return true;
        ...
        setOrReportIndexedColor(S) {
          const w = [], y = S.split(";");
          for (; y.length > 1; ) {
            const L = y.shift(), B = y.shift();
            if (/^\d+$/.exec(L)) {
              const H = parseInt(L);
              if (U(H)) if (B === "?") w.push({ type: 0, index: H });
              else {
          ...
          return w.length && this._onColor.fire(w), true;
        }
        setHyperlink(S) {
          const w = S.split(";");
        ...
        _createHyperlink(S, w) {
          ...
          return B !== -1 && (L = y[B].slice(3) || void 0), this._curAttrData.extended = this._curAttrData.extended.clone(), this._curAttrData.extended.urlId = this._oscLinkService.registerLink({ id: L, uri: w }), this._curAttrData.updateExtended(), true;
        }
        _finishHyperlink() {
        ...
        _setOrReportSpecialColor(S, w) {
          const y = S.split(";");
          for (let L = 0; L < y.length && !(w >= this._specialColors.length); ++L, ++w) if (y[L] === "?") this._onColor.fire([{ type: 0, index: this._specialColors[w] }]);
          else {
            const B = (0, m.parseColor)(y[L]);
            B && this._onColor.fire([{ type: 1, index: this._specialColors[w], color: B }]);
          }
          return true;
        }
        ...
        restoreIndexedColor(S) {
          ...
          const w = [], y = S.split(";");
          for (let L = 0; L < y.length; ++L) if (/^\d+$/.exec(y[L])) {
        ...
        selectCharset(S) {
          return S.length !== 2 ? (this.selectDefaultCharset(), true) : (S[0] === "/" || this._charsetService.setgCharset(E[S[0]], d.CHARSETS[S[1]] || d.DEFAULT_CHARSET), true);
        }
        index() {
        ...
        screenAlignmentPattern() {
          ...
          for (let w = 0; w < this._bufferService.rows; ++w) {
            const y = this._activeBuffer.ybase + this._activeBuffer.y + w, L = this._activeBuffer.lines.get(y);
            L && (L.fill(S), L.isWrapped = false);
          }
          return this._dirtyRowTracker.markAllDirty(), this._setCursor(0, 0), true;
        }
        requestStatusString(S, w) {
          const y = this._bufferService.buffer, L = this._optionsService.rawOptions;
          return ((B) => (this._coreService.triggerDataEvent(`${n.C0.ESC}${B}${n.C0.ESC}\\`), true))(S === '"q' ? `P1$r${this._curAttrData.isProtected() ? 1 : 0}"q` : S === '"p' ? 'P1$r61;1"p' : S === "r" ? `P1$r${y.scrollTop + 1};${y.scrollBottom + 1}r` : S === "m" ? "P1$r0m" : S === " q" ? `P1$r${{ block: 2, underline: 4, bar: 6 }[L.cursorStyle] - (L.cursorBlink ? 1 : 0)} q` : "P0$r");
        }
        markRangeDirty(S, w) {
      ...
      let I = class {
        ...
        markRangeDirty(P, S) {
          P > S && (x = P, P = S, S = x), P < this.start && (this.start = P), S > this.end && (this.end = S);
        }
        markAllDirty() {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.getDisposeArrayDisposable = r.disposeArray = r.toDisposable = r.MutableDisposable = r.Disposable = void 0, r.Disposable = class {
        ...
        set value(l) {
          var _a;
          this._isDisposed || l === this._value || ((_a = this._value) == null ? void 0 : _a.dispose(), this._value = l);
        }
        clear() {
          this.value = void 0;
        }
        ...
        return { dispose: l };
      }, r.disposeArray = o, r.getDisposeArrayDisposable = function(l) {
        return { dispose: () => o(l) };
      };
    }, 1505: (O, r) => {
      ...
      r.TwoKeyMap = o, r.FourKeyMap = class {
        ...
        set(l, f, n, d, v) {
          this._data.get(l, f) || this._data.set(l, f, new o()), this._data.get(l, f).set(n, d, v);
        }
        get(l, f, n, d) {
          var _a;
          return (_a = this._data.get(l, f)) == null ? void 0 : _a.get(n, d);
        }
        clear() {
          this._data.clear();
        }
      ...
      const o = r.isNode ? "node" : navigator.userAgent, l = r.isNode ? "node" : navigator.platform;
      ...
      }, r.isMac = ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].includes(l), r.isIpad = l === "iPad", r.isIphone = l === "iPhone", r.isWindows = ["Windows", "Win16", "Win32", "WinCE"].includes(l), r.isLinux = l.indexOf("Linux") >= 0, r.isChromeOS = /\bCrOS\b/.test(o);
    }, 6106: (O, r) => {
      ...
      r.SortedList = class {
        ...
        delete(l) {
          ...
          if (f === void 0 || (o = this._search(f), o === -1) || this._getKey(this._array[o]) !== f) return false;
          do
            if (this._array[o] === l) return this._array.splice(o, 1), true;
      ...
      r.PriorityTaskQueue = n, r.IdleTaskQueue = !l.isNode && "requestIdleCallback" in window ? class extends f {
        _requestCallback(d) {
      ...
      const l = o(6349), f = o(7226), n = o(3734), d = o(8437), v = o(4634), g = o(511), h = o(643), i = o(4863), s = o(7116);
      r.MAX_BUFFER_SIZE = 4294967295, r.Buffer = class {
        ...
        resize(e, t) {
          ...
          if (_ > this.lines.maxLength && (this.lines.maxLength = _), this.lines.length > 0) {
            if (this._cols < e) for (let c = 0; c < this.lines.length; c++) u += +this.lines.get(c).resize(e, a);
            let p = 0;
          ...
          if (this.scrollBottom = t - 1, this._isReflowEnabled && (this._reflow(e, t), this._cols > e)) for (let p = 0; p < this.lines.length; p++) u += +this.lines.get(p).resize(e, a);
        ...
        _reflowLarger(e, t) {
          const a = (0, v.reflowLargerGetLinesToRemove)(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(d.DEFAULT_ATTR_DATA));
          if (a.length > 0) {
            const u = (0, v.reflowLargerCreateNewLayout)(this.lines, a);
        ...
        _reflowSmaller(e, t) {
          const a = this.getNullCell(d.DEFAULT_ATTR_DATA), u = [];
          let _ = 0;
          for (let p = this.lines.length - 1; p >= 0; p--) {
            ...
            const k = m[m.length - 1].getTrimmedLength(), D = (0, v.reflowSmallerGetNewLineLengths)(m, this._cols, e), b = D.length - m.length;
            let x;
            ...
            const T = [];
            for (let y = 0; y < b; y++) {
              const L = this.getBlankLine(d.DEFAULT_ATTR_DATA, true);
              T.push(L);
            }
            T.length > 0 && (u.push({ start: p + m.length + _, newLines: T }), _ += T.length), m.push(...T);
            let I = D.length - 1, U = D[I];
            U === 0 && (I--, U = D[I]);
            let P = m.length - b - 1, S = k;
            for (; P >= 0; ) {
              const y = Math.min(S, U);
              if (m[I] === void 0) break;
              if (m[I].copyCellsFrom(m[P], S - y, U - y, y, true), U -= y, U === 0 && (I--, U = D[I]), S -= y, S === 0) {
                P--;
            ...
            let w = b - x;
            for (; w-- > 0; ) this.ybase === 0 ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + _) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
          ...
          if (u.length > 0) {
            ...
            let b = 0;
            for (let I = Math.min(this.lines.maxLength - 1, m + _ - 1); I >= 0; I--) if (D && D.start > E + b) {
              for (let U = D.newLines.length - 1; U >= 0; U--) this.lines.set(I--, D.newLines[U]);
              I++, p.push({ index: E + 1, amount: D.newLines.length }), b += D.newLines.length, D = u[++k];
            } else this.lines.set(I, c[E--]);
            let x = 0;
            for (let I = p.length - 1; I >= 0; I--) p[I].index += x, this.lines.onInsertEmitter.fire(p[I]), x += p[I].amount;
            const T = Math.max(0, m + _ - this.lines.maxLength);
            T > 0 && this.lines.onTrimEmitter.fire(T);
          }
        }
        translateBufferLineToString(e, t, a = 0, u) {
          const _ = this.lines.get(e);
          return _ ? _.translateToString(t, a, u) : "";
        }
      ...
      const l = o(3734), f = o(511), n = o(643), d = o(482);
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.getRangeLength = void 0, r.getRangeLength = function(o, l) {
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.getWrappedLineTrimmedLength = r.reflowSmallerGetNewLineLengths = r.reflowLargerApplyNewLayout = r.reflowLargerCreateNewLayout = r.reflowLargerGetLinesToRemove = void 0, r.reflowLargerGetLinesToRemove = function(l, f, n, d, v) {
        ...
        for (let h = 0; h < l.length - 1; h++) {
          ...
          let t = 0, a = o(e, t, f), u = 1, _ = 0;
          for (; u < e.length; ) {
            const c = o(e, u, f), m = c - _, E = n - a, k = Math.min(m, E);
            e[t].copyCellsFrom(e[u], _, a, k, false), a += k, a === n && (t++, a = 0), _ += k, _ === c && (u++, _ = 0), a === 0 && t !== 0 && e[t - 1].getWidth(n - 1) === 2 && (e[t].copyCellsFrom(e[t - 1], n - 1, a++, 1, false), e[t - 1].setCell(n - 1, v));
          }
        ...
        const d = [], v = l.map((s, e) => o(l, e, f)).reduce((s, e) => s + e);
        let g = 0, h = 0, i = 0;
        for (; i < v; ) {
          if (v - i < n) {
            d.push(v - i);
      ...
      const l = o(8460), f = o(844), n = o(9092);
      ...
      const l = o(482), f = o(643), n = o(3734);
...
`, n.VT = "\v", n.FF = "\f", n.CR = "\r", n.SO = "", n.SI = "", n.DLE = "", n.DC1 = "", n.DC2 = "", n.DC3 = "", n.DC4 = "", n.NAK = "", n.SYN = "", n.ETB = "", n.CAN = "", n.EM = "", n.SUB = "", n.ESC = "\x1B", n.FS = "", n.GS = "", n.RS = "", n.US = "", n.SP = " ", n.DEL = "\x7F";
      ...
      const l = o(2584), f = { 48: ["0", ")"], 49: ["1", "!"], 50: ["2", "@"], 51: ["3", "#"], 52: ["4", "$"], 53: ["5", "%"], 54: ["6", "^"], 55: ["7", "&"], 56: ["8", "*"], 57: ["9", "("], 186: [";", ":"], 187: ["=", "+"], 188: [",", "<"], 189: ["-", "_"], 190: [".", ">"], 191: ["/", "?"], 192: ["`", "~"], 219: ["[", "{"], 220: ["\\", "|"], 221: ["]", "}"], 222: ["'", '"'] };
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.Utf8ToUtf32 = r.StringToUtf32 = r.utf32ToString = r.stringFromCodePoint = void 0, r.stringFromCodePoint = function(o) {
        return o > 65535 ? (o -= 65536, String.fromCharCode(55296 + (o >> 10)) + String.fromCharCode(o % 1024 + 56320)) : String.fromCharCode(o);
      }, r.utf32ToString = function(o, l = 0, f = o.length) {
        let n = "";
        for (let d = l; d < f; ++d) {
          let v = o[d];
        ...
        decode(o, l) {
          ...
          if (this.interim[0]) {
            ...
            a || (c === 2 ? u < 128 ? s-- : l[h++] = u : c === 3 ? u < 2048 || u >= 55296 && u <= 57343 || u === 65279 || (l[h++] = u) : u < 65536 || u > 1114111 || (l[h++] = u)), this.interim.fill(0);
          }
          const e = f - 4;
          let t = s;
          for (; t < f; ) {
            for (; !(!(t < e) || 128 & (n = o[t]) || 128 & (d = o[t + 1]) || 128 & (v = o[t + 2]) || 128 & (g = o[t + 3])); ) l[h++] = n, l[h++] = d, l[h++] = v, l[h++] = g, t += 4;
      ...
      const l = o(482), f = o(8742), n = o(5770), d = [];
      r.DcsParser = class {
        constructor() {
      ...
      const l = o(844), f = o(8742), n = o(6242), d = o(6351);
      class v {
        constructor(s) {
        ...
        addMany(s, e, t, a) {
          for (let u = 0; u < s.length; u++) this.table[e << 8 | s[u]] = t << 4 | a;
        }
      }
      r.TransitionTable = v;
      const g = 160;
      r.VT500_TRANSITION_TABLE = function() {
        const i = new v(4095), s = Array.apply(null, Array(256)).map((p, c) => c), e = (p, c) => s.slice(p, c), t = e(32, 127), a = e(0, 24);
      ...
      class h extends l.Disposable {
        constructor(s = r.VT500_TRANSITION_TABLE) {
          super(), this._transitions = s, this._parseStack = { state: 0, handlers: [], handlerPos: 0, transition: 0, chunkPos: 0 }, this.initialState = 0, this.currentState = this.initialState, this._params = new f.Params(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, a) => {
        ...
        _preserveStack(s, e, t, a, u) {
          this._parseStack.state = s, this._parseStack.handlers = e, this._parseStack.handlerPos = t, this._parseStack.transition = a, this._parseStack.chunkPos = u;
        }
        parse(s, e, t) {
          let a, u = 0, _ = 0, p = 0;
          if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, p = this._parseStack.chunkPos + 1;
            ...
            switch (this._parseStack.state) {
              case 3:
                if (t === false && m > -1) {
                  for (; m >= 0 && (a = c[m](this._params), a !== true); m--) if (a instanceof Promise) return this._parseStack.handlerPos = m, a;
                }
                this._parseStack.handlers = [];
                break;
              case 4:
                if (t === false && m > -1) {
                  for (; m >= 0 && (a = c[m](), a !== true); m--) if (a instanceof Promise) return this._parseStack.handlerPos = m, a;
                }
                this._parseStack.handlers = [];
                break;
              case 6:
                if (u = s[this._parseStack.chunkPos], a = this._dcsParser.unhook(u !== 24 && u !== 26, t), a) return a;
                u === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
                break;
              case 5:
                if (u = s[this._parseStack.chunkPos], a = this._oscParser.end(u !== 24 && u !== 26, t), a) return a;
                u === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
            }
          ...
          for (let c = p; c < e; ++c) {
            switch (u = s[c], _ = this._transitions.table[this.currentState << 8 | (u < 160 ? u : g)], _ >> 4) {
              ...
              case 7:
                ...
                for (; E >= 0 && (a = m[E](this._params), a !== true); E--) if (a instanceof Promise) return this._preserveStack(3, m, E, _, c), a;
                E < 0 && this._csiHandlerFb(this._collect << 8 | u, this._params), this.precedingJoinState = 0;
                break;
              case 8:
                do
                  switch (u) {
              ...
              case 10:
                ...
                for (; D >= 0 && (a = k[D](), a !== true); D--) if (a instanceof Promise) return this._preserveStack(4, k, D, _, c), a;
                D < 0 && this._escHandlerFb(this._collect << 8 | u), this.precedingJoinState = 0;
                break;
              case 11:
              ...
              case 12:
                ...
                break;
              case 13:
                for (let b = c + 1; ; ++b) if (b >= e || (u = s[b]) === 24 || u === 26 || u === 27 || u > 127 && u < g) {
                  this._dcsParser.put(s, c, b), c = b - 1;
                  break;
                }
                break;
              case 14:
                if (a = this._dcsParser.unhook(u !== 24 && u !== 26), a) return this._preserveStack(6, [], 0, _, c), a;
              ...
              case 4:
                ...
                break;
              case 5:
                for (let b = c + 1; ; b++) if (b >= e || (u = s[b]) < 32 || u > 127 && u < g) {
                  this._oscParser.put(s, c, b), c = b - 1;
                  break;
                }
                break;
              case 6:
                if (a = this._oscParser.end(u !== 24 && u !== 26), a) return this._preserveStack(5, [], 0, _, c), a;
                u === 27 && (_ |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
            }
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.AddonManager = void 0, r.AddonManager = class {
        ...
        loadAddon(o, l) {
          ...
          this._addons.push(f), l.dispose = () => this._wrappedAddonDispose(f), l.activate(o);
        }
        _wrappedAddonDispose(o) {
          if (o.isDisposed) return;
          let l = -1;
          for (let f = 0; f < this._addons.length; f++) if (this._addons[f] === o) {
            l = f;
            break;
          }
          if (l === -1) throw new Error("Could not dispose an addon that has not been loaded");
          o.isDisposed = true, o.dispose.apply(o.instance), this._addons.splice(l, 1);
        }
      };
    }, 8771: (O, r, o) => {
      Object.defineProperty(r, "__esModule", { value: true }), r.BufferApiView = void 0;
      const l = o(3785), f = o(511);
      ...
      const l = o(8771), f = o(8460), n = o(844);
      ...
      Object.defineProperty(r, "__esModule", { value: true }), r.ParserApi = void 0, r.ParserApi = class {
        ...
        registerCsiHandler(o, l) {
          return this._core.registerCsiHandler(o, (f) => l(f.toArray()));
        }
        addCsiHandler(o, l) {
          return this.registerCsiHandler(o, l);
        }
        registerDcsHandler(o, l) {
          return this._core.registerDcsHandler(o, (f, n) => l(f, n.toArray()));
        }
        addDcsHandler(o, l) {
      ...
      var l = this && this.__decorate || function(i, s, e, t) {
        var a, u = arguments.length, _ = u < 3 ? s : t === null ? t = Object.getOwnPropertyDescriptor(s, e) : t;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") _ = Reflect.decorate(i, s, e, t);
        else for (var p = i.length - 1; p >= 0; p--) (a = i[p]) && (_ = (u < 3 ? a(_) : u > 3 ? a(s, e, _) : a(s, e)) || _);
      ...
      const n = o(8460), d = o(844), v = o(5295), g = o(2585);
      ...
      let h = r.BufferService = class extends d.Disposable {
        ...
        scroll(i, s = false) {
          ...
          const a = e.ybase + e.scrollTop, u = e.ybase + e.scrollBottom;
          if (e.scrollTop === 0) {
            ...
            const _ = u - a + 1;
            e.lines.shiftElements(a + 1, _ - 1, -1), e.lines.set(u, t.clone());
          }
      ...
      const n = o(2585), d = o(8460), v = o(844), g = { NONE: { events: 0, restrict: () => false }, X10: { events: 1, restrict: (t) => t.button !== 4 && t.action === 1 && (t.ctrl = false, t.alt = false, t.shift = false, true) }, VT200: { events: 19, restrict: (t) => t.action !== 32 }, DRAG: { events: 23, restrict: (t) => t.action !== 32 || t.button !== 3 }, ANY: { events: 31, restrict: (t) => true } };
      function h(t, a) {
        let u = (t.ctrl ? 16 : 0) | (t.shift ? 4 : 0) | (t.alt ? 8 : 0);
        return t.button === 4 ? (u |= 64, u |= t.action) : (u |= 3 & t.button, 4 & t.button && (u |= 64), 8 & t.button && (u |= 128), t.action === 32 ? u |= 32 : t.action !== 0 || a || (u |= 3)), u;
      }
      const i = String.fromCharCode, s = { DEFAULT: (t) => {
        const a = [h(t, false) + 32, t.col + 32, t.row + 32];
        return a[0] > 255 || a[1] > 255 || a[2] > 255 ? "" : `\x1B[M${i(a[0])}${i(a[1])}${i(a[2])}`;
      }, SGR: (t) => {
        const a = t.action === 0 && t.button !== 4 ? "m" : "M";
        return `\x1B[<${h(t, true)};${t.col};${t.row}${a}`;
      }, SGR_PIXELS: (t) => {
        const a = t.action === 0 && t.button !== 4 ? "m" : "M";
        return `\x1B[<${h(t, true)};${t.x};${t.y}${a}`;
      } };
      let e = r.CoreMouseService = class extends v.Disposable {
        ...
        triggerMouseEvent(t) {
          ...
          return a && (this._activeEncoding === "DEFAULT" ? this._coreService.triggerBinaryEvent(a) : this._coreService.triggerDataEvent(a, true)), this._lastEvent = t, true;
        }
        explainEvents(t) {
        ...
        _equalEvents(t, a, u) {
          if (u) {
            if (t.x !== a.x || t.y !== a.y) return false;
          } else if (t.col !== a.col || t.row !== a.row) return false;
      ...
      const n = o(1439), d = o(8460), v = o(844), g = o(2585), h = Object.freeze({ insertMode: false }), i = Object.freeze({ applicationCursorKeys: false, applicationKeypad: false, bracketedPasteMode: false, origin: false, reverseWraparound: false, sendFocus: false, wraparound: true });
      let s = r.CoreService = class extends v.Disposable {
        constructor(e, t, a) {
          super(), this._bufferService = e, this._logService = t, this._optionsService = a, this.isCursorInitialized = false, this.isCursorHidden = false, this._onData = this.register(new d.EventEmitter()), this.onData = this._onData.event, this._onUserInput = this.register(new d.EventEmitter()), this.onUserInput = this._onUserInput.event, this._onBinary = this.register(new d.EventEmitter()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this.register(new d.EventEmitter()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = (0, n.clone)(h), this.decPrivateModes = (0, n.clone)(i);
        }
        reset() {
        ...
        triggerDataEvent(e, t = false) {
          ...
          t && this._optionsService.rawOptions.scrollOnUserInput && a.ybase !== a.ydisp && this._onRequestScrollToBottom.fire(), t && this._onUserInput.fire(), this._logService.debug(`sending data "${e}"`, () => e.split("").map((u) => u.charCodeAt(0))), this._onData.fire(e);
        }
      ...
      const l = o(8055), f = o(8460), n = o(844), d = o(6106);
      let v = 0, g = 0;
      class h extends n.Disposable {
        ...
        *getDecorationsAtCell(e, t, a) {
          let u = 0, _ = 0;
          for (const p of this._decorations.getKeyIterator(t)) u = p.options.x ?? 0, _ = u + (p.options.width ?? 1), e >= u && e < _ && (!a || (p.options.layer ?? "bottom") === a) && (yield p);
        }
        forEachDecorationAtCell(e, t, a, u) {
          this._decorations.forEachByKey(t, (_) => {
            v = _.options.x ?? 0, g = v + (_.options.width ?? 1), e >= v && e < g && (!a || (_.options.layer ?? "bottom") === a) && u(_);
          });
        }
      }
      ...
      const n = o(844), d = o(2585), v = { trace: d.LogLevelEnum.TRACE, debug: d.LogLevelEnum.DEBUG, info: d.LogLevelEnum.INFO, warn: d.LogLevelEnum.WARN, error: d.LogLevelEnum.ERROR, off: d.LogLevelEnum.OFF };
      let g, h = r.LogService = class extends n.Disposable {
        ...
        trace(i, ...s) {
          var _a;
          this._logLevel <= d.LogLevelEnum.TRACE && this._log(((_a = this._optionsService.options.logger) == null ? void 0 : _a.trace.bind(this._optionsService.options.logger)) ?? console.log, i, s);
        }
        debug(i, ...s) {
          var _a;
          this._logLevel <= d.LogLevelEnum.DEBUG && this._log(((_a = this._optionsService.options.logger) == null ? void 0 : _a.debug.bind(this._optionsService.options.logger)) ?? console.log, i, s);
        }
        info(i, ...s) {
          var _a;
          this._logLevel <= d.LogLevelEnum.INFO && this._log(((_a = this._optionsService.options.logger) == null ? void 0 : _a.info.bind(this._optionsService.options.logger)) ?? console.info, i, s);
        }
        warn(i, ...s) {
          var _a;
          this._logLevel <= d.LogLevelEnum.WARN && this._log(((_a = this._optionsService.options.logger) == null ? void 0 : _a.warn.bind(this._optionsService.options.logger)) ?? console.warn, i, s);
        }
        error(i, ...s) {
          var _a;
          this._logLevel <= d.LogLevelEnum.ERROR && this._log(((_a = this._optionsService.options.logger) == null ? void 0 : _a.error.bind(this._optionsService.options.logger)) ?? console.error, i, s);
        }
      };
      r.LogService = h = l([f(0, d.IOptionsService)], h), r.setTraceLogger = function(i) {
        ...
        e.value = function(...a) {
          ...
          g.trace(`GlyphRenderer#${t.name}(${a.map((_) => JSON.stringify(_)).join(", ")})`);
          const u = t.apply(this, a);
      ...
      const l = o(8460), f = o(844), n = o(6114);
      ...
      var l = this && this.__decorate || function(v, g, h, i) {
        ...
        else for (var a = v.length - 1; a >= 0; a--) (s = v[a]) && (t = (e < 3 ? s(t) : e > 3 ? s(g, h, t) : s(g, h)) || t);
      ...
      let d = r.OscLinkService = class {
        ...
        registerLink(v) {
          ...
          if (v.id === void 0) {
            const a = g.addMarker(g.ybase + g.y), u = { data: v, id: this._nextId++, lines: [a] };
        ...
        getLinkData(v) {
          var _a;
          return (_a = this._dataByLinkId.get(v)) == null ? void 0 : _a.data;
        }
        _getEntryIdKey(v) {
          return `${v.id};;${v.uri}`;
        }
      ...
      r.serviceRegistry = /* @__PURE__ */ new Map(), r.getServiceDependencies = function(f) {
        ...
        const n = function(d, v, g) {
          ...
          (function(h, i, s) {
            i[o] === i ? i[l].push({ id: h, index: s }) : (i[l] = [{ id: h, index: s }], i[o] = i);
          })(n, d, g);
        };
    ...
    function G(O) {
      ...
      var o = Y[O] = { exports: {} };
      return te[O].call(o.exports, o, o.exports, G), o.exports;
    }
    var ie = {};
    return (() => {
      var O = ie;
      Object.defineProperty(O, "__esModule", { value: true }), O.Terminal = void 0;
      const r = G(9042), o = G(3236), l = G(844), f = G(5741), n = G(8285), d = G(7975), v = G(7090), g = ["cols", "rows"];
      class h extends l.Disposable {
        constructor(s) {
          super(), this._core = this.register(new o.Terminal(s)), this._addonManager = this.register(new f.AddonManager()), this._publicOptions = { ...this._core.options };
          const e = (a) => this._core.options[a], t = (a, u) => {
            this._checkReadonlyOptions(a), this._core.options[a] = u;
          };
          for (const a in this._core.options) {
            const u = { get: e.bind(this, a), set: t.bind(this, a) };
            Object.defineProperty(this._publicOptions, a, u);
          }
        }
