  ...
  for (var i = 0; i < s.length; i++) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const e in t) if (e !== "default" && !(e in o)) {
        ...
        r && Object.defineProperty(o, e, r.get ? r : { enumerable: true, get: () => t[e] });
      }
    }
  }
    ...
    return (() => {
      ...
      Object.defineProperty(t, "__esModule", { value: true }), t.FitAddon = void 0, t.FitAddon = class {
        ...
        proposeDimensions() {
          ...
          const p = this._terminal.options.scrollback === 0 ? 0 : e.viewport.scrollBarWidth, a = window.getComputedStyle(this._terminal.element.parentElement), c = parseInt(a.getPropertyValue("height")), d = Math.max(0, parseInt(a.getPropertyValue("width"))), n = window.getComputedStyle(this._terminal.element), h = c - (parseInt(n.getPropertyValue("padding-top")) + parseInt(n.getPropertyValue("padding-bottom"))), m = d - (parseInt(n.getPropertyValue("padding-right")) + parseInt(n.getPropertyValue("padding-left"))) - p;
          return { cols: Math.max(2, Math.floor(m / r.css.cell.width)), rows: Math.max(1, Math.floor(h / r.css.cell.height)) };
        }
      };
    })(), i;
  })());
