...
from maude.tools.handlers.shared import SHARED_DIR
...
def _dispatch_video_pre_publish_checklist(args: dict[str, Any]) -> str:
    ...
    link_in_description = _as_bool(
        args.get("link_in_description"),
        bool(link_url and link_url in description)
        or "description" in link_placement.lower()
        or "caption" in link_placement.lower(),
    )
